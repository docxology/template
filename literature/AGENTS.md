...
**Integration:**
- Automatically cited in `manuscript/99_references.md`
- BibTeX compilation during PDF generation
- Cross-referenced with manuscript citations
...
```markdown
Recent advances in machine learning \cite{smith2024machine}
show significant improvements in performance metrics.
```

**Bibliography Generation:**
- `99_references.md` includes `\bibliography{references}`
- BibTeX compilation resolves all citations
- Cross-references work in final PDF
