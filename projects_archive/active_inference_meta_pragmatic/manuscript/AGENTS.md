...
This directory contains the complete research manuscript for "Active Inference as a Meta-(Pragmatic/Epistemic) Method". The manuscript is structured with numbered sections, cross-references, and comprehensive documentation.
