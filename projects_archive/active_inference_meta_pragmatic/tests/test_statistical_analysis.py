...
class TestStatisticalAnalyzer:
    ...
    def test_calculate_descriptive_stats_comprehensive(self):
        ...
        expected_keys = ['count', 'mean', 'std', 'var', 'median', 'min', 'max',
    ...
    def test_calculate_correlation_spearman(self):
        ...
        assert isinstance(result, dict)
        assert abs(result['correlation'] - 1.0) < 1e-10  # Allow for floating point precision
    ...
    def test_analyze_algorithm_performance_single_algorithm(self):
        ...
        results = {
            'algorithm_a': np.array([0.8, 0.85, 0.82])
        }
