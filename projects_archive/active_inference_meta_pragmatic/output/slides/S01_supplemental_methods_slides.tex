...
\begin{block}{Complete Generative Model Specifications}
...
\begin{block}{Extended EFE Derivation}
\protect\phantomsection\label{sec:extended_efe_derivation}
\begin{block}{Complete EFE Formulation}
\protect\phantomsection\label{complete-efe-formulation}
