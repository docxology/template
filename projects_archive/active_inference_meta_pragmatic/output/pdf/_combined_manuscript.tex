...
that minimize variational free energy through perception and action.
Recent advances have extended Active Inference to scale-free
formulations \citep{friston2025scalefree} and variational planning
\citep{champion2025efeplanning}, while metacognitive architectures
\citep{metamind2025, sofai2025} have demonstrated the practical
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{../figures/active_inference_concepts.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{../figures/fep_visualization.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{../figures/meta_cognition_diagram.png}
