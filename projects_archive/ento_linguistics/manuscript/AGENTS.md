...
As shown in \ref{fig:example_figure}...
```
...
**Path References:**
- Use relative paths from the `project/` directory (e.g., `../output/figures/convergence_plot.png`)
...
- `example_figure.png` - Basic src/ integration example
- `convergence_plot.png` - Algorithm convergence comparison
- `experimental_setup.png` - Experimental pipeline diagram
- `scalability_analysis.png` - Performance scaling analysis
- `ablation_study.png` - Component contribution analysis
- `convergence_analysis.png` - Scientific convergence figure
- `time_series_analysis.png` - Time series visualization
