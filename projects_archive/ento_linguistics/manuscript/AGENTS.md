...
- Use relative paths from the `project/` directory (e.g., `../output/figures/domain_comparison.png`)
...
- `unit_of_individuality_term_frequencies.png` - Term frequencies (Unit of Individuality)
- `unit_of_individuality_ambiguities.png` - Ambiguity patterns (Unit of Individuality)
- `behavior_and_identity_term_frequencies.png` - Term frequencies (Behavior & Identity)
- `behavior_and_identity_ambiguities.png` - Ambiguity patterns (Behavior & Identity)
...
- `sex_and_reproduction_term_frequencies.png` - Term frequencies (Sex & Reproduction)
