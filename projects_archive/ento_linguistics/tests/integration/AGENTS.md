...
The `project/tests/integration/` directory contains comprehensive integration tests that validate the end-to-end functionality of the research template system. These tests ensure that all components work together correctly, from data generation through figure creation to final manuscript production.
...
def test_complete_research_pipeline():
    """Test the complete research pipeline from data generation to manuscript."""
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        # Step 4: Combine into complete manuscript
...
@pytest.fixture
def mock_figure_data():
    """Generate mock data for figure testing."""
    np.random.seed(123)
    return {
