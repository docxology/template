...
class TestBenchmarkComparison:
    ...
    def test_benchmark_comparison(self):
        ...
        metrics = {
            "execution_time": [10.0, 8.0, 12.0],
            "accuracy": [0.9, 0.95, 0.85]
        }
...
class TestStatisticalSignificance:
    ...
    def test_check_statistical_significance(self):
        ...
        from performance import check_statistical_significance
    ...
    def test_estimate_complexity_single_size(self):
        ...
        from performance import _estimate_complexity
    ...
    def test_benchmark_comparison_empty_values(self):
        ...
        assert comparison["best_method"] == "Method A"  # best_idx=0 when values is empty
