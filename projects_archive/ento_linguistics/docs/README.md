...
graph TD
    ...
    subgraph Standards["Development Standards"]
        ...
        TESTING_STDS[Testing Standards<br/>No mocks, data]
...
- [`AGENTS.md`](AGENTS.md) - technical documentation of all documents in this directory
...
See [AGENTS.md](AGENTS.md) for technical documentation of all documents in this directory.