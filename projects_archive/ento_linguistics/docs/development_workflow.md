...
This guide provides a, step-by-step workflow for developing in the project, integrating all development standards and best practices.

## Overview

The development workflow follows a structured approach that ensures code quality, testing, and proper documentation. All development must follow the standards outlined in the `.cursorrules/` directory.
