...
The project follows development standards defined in the `.cursorrules/` directory. This document shows how project practices align with these standards and provides compliance verification.
...
| **Type Hints** ([`.cursorrules/type_hints_standards.md`](../../../.cursorrules/type_hints_standards.md)) | All public APIs typed, annotations | ✅ Full | mypy validation |
...
| Standard | Project Practice | Compliance | Reference |
|----------|------------------|------------|-----------|
| **No Mocks Policy** ([`.cursorrules/testing_standards.md`](../../../.cursorrules/testing_standards.md)) | data testing, no MagicMock/pytest-mock | ✅ Full | `verify_no_mocks.py` |
...
| Standard | Project Practice | Compliance | Reference |
|----------|------------------|------------|-----------|
| **AGENTS.md Structure** ([`.cursorrules/documentation_standards.md`](../../../.cursorrules/documentation_standards.md)) | docs with all required sections | ✅ Full | All AGENTS.md files |
...
| **Public API** ([`.cursorrules/infrastructure_modules.md`](../../../.cursorrules/infrastructure_modules.md)) | Clear `__init__.py` exports, docs | ✅ Full | Module organization |
...
\caption{Experimental pipeline showing the workflow}
...
```yaml
# From config.yaml.example - metadata structure
paper:
  title: "Novel Optimization Framework for Machine Learning"
  subtitle: "A Approach to Large-Scale Problems"
  version: "1.0"
...
4. **documentation** ([`.cursorrules/infrastructure_modules.md`](../../../.cursorrules/infrastructure_modules.md))
...
- ✅ **Documentation**: AGENTS.md + README.md pattern, cross-references
...
- ✅ **Type Safety**: type hints on all APIs
...
2. **Mock usage** - Never use mocks, test with data
