...
from infrastructure.project.git_guards import offending_tracked_tools  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not offenders:
        print("Tools confidentiality guard: only public template tools are tracked.")
        return 0

    print(
        "CONFIDENTIALITY VIOLATION: non-template tool paths are tracked by git.\n"
