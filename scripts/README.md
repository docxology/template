...
The pipeline automatically generates comprehensive reports in `projects/{name}/output/reports/`:
...
3. **Test Execution** → Run comprehensive test suites (infrastructure + project)
