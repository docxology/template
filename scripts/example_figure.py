...
def main() -> None:
    ...
    try:
        from scientific.example import add_numbers, multiply_numbers, calculate_average, find_maximum, find_minimum
        print("✅ Successfully imported functions from src/scientific/example.py")
    except (ImportError, SyntaxError) as e:
        print(f"❌ Failed to import from src/scientific/example.py: {e}")
        return
    ...
    print(f"Data analysis using src/ functions:")
    print(f"  Average: {avg_y:.6f}")
