#!/usr/bin/env python3
"""Backward-compatible shim — script moved to scripts/pipeline/stage_09_provenance_record.py.
...
warnings.warn(
    "scripts/09_provenance_record.py is deprecated. Use scripts/pipeline/stage_09_provenance_record.py instead.",
    DeprecationWarning,
    stacklevel=1,
)
print(
...
from scripts.pipeline.stage_09_provenance_record import main  # noqa: E402
