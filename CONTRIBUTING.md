...
- **Confidentiality.** This is a public repo: only generated public-scope paths
  may be tracked under `projects/`, `fonds/`, `rules/`, and `tools/`.
  `scripts/audit/check_tracked_all.py` blocks every other lifecycle path in
  pre-push and CI.
