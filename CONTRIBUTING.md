...
- **Confidentiality.** This is a public repo: only `projects/template_active_inference`, `projects/template_autoresearch_project`, `projects/template_code_project`, `projects/template_prose_project`, and `projects/template_template` are tracked. Never commit any other project under `projects/` — `scripts/check_tracked_projects.py` blocks it in the pre-push hook and CI.
