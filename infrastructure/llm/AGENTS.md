...
### 3. Long Responses (> 500 tokens), detailed answers with extended output:
...
- Combined with `temperature=0.0` for reproducible results
...
Based on the document you shared, this is an manuscript! 🚀
...
- [`docs/rules/llm_standards.md`](../../docs/rules/llm_standards.md) - LLM development standards
