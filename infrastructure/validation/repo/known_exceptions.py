...
CODE_EXAMPLE_PATTERNS: list[str] = [
    ...
    "biology_analysis.py",
    "run_upstream_test_suite.sh",
    "_quality_report.py",
    "docs_build.sh",
    "setup_lean.sh",
    "scientific/data_processing.py",
    "infrastructure/plots.py",
    "test_figure_manager.py",
    "test_validation/test_new_validator.py",
]
...
def is_valid_directory_reference(target: str) -> bool:
    ...
    # This handles references like "projects/example_project/" without hardcoding
