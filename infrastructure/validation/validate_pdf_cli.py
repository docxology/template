...
try:
    ...
    print(f"❌ Error: Failed to import from infrastructure/validation/pdf_validator.py")
    print(f"   {e}")
    print(f"   Ensure infrastructure/validation/pdf_validator.py exists and is properly formatted")
    sys.exit(1)
