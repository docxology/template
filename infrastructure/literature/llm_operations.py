...
class LiteratureLLMOperations:
    ...
    def generate_literature_review(
        ...
        for paper in selected_papers:
            ...
            summary_path = Path("literature/summaries") / f"{paper.citation_key}_summary.md"
        ...
        # Create the prompt
        from infrastructure.llm.templates import LiteratureReviewSynthesis
    ...
    def generate_science_communication(
        ...
        # Create the prompt
        from infrastructure.llm.templates import ScienceCommunicationNarrative
    ...
    def generate_comparative_analysis(
        ...
        # Create the prompt
        from infrastructure.llm.templates import ComparativeAnalysis
    ...
    def identify_research_gaps(
        ...
        # Create the prompt
        from infrastructure.llm.templates import ResearchGapIdentification
    ...
    def analyze_citation_network(self, papers: List[LibraryEntry]) -> LLMOperationResult:
        ...
        # Create the prompt
        from infrastructure.llm.templates import CitationNetworkAnalysis
