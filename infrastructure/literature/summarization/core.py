    ...
    def summarize_paper(
        ...
        if pdf_text:
            ...
            logger.warning(
                ...
                f"literature/extracted_text/{citation_key}.txt. "
        ...
        try:
            ...
            # Note: Extracted text is already saved in literature/extracted_text/ by extraction step
            try:
                debug_dir = Path("literature/summaries") / "_debug"
