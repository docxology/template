...
to literature/extracted_text/ for use in the summarization pipeline.
"""
...
class TextExtractor:
    ...
    def __init__(self):
        ...
        self.extracted_text_dir = Path("literature/extracted_text")
    ...
    def extract_and_save(
        ...
        if extracted_text_path.exists():
            ...
            logger.info(
                f"[{citation_key}] Extracted text already exists: {extracted_text_path} "
                f"({existing_size:,} bytes). Skipping extraction."
            )
        ...
        try:
            ...
            try:
                ...
                logger.info(
                    ...
                    f"({extraction_time:.2f}s) -> {extracted_text_path}"
                )
