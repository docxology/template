...
def create_venue_distribution_plot(
    ...
    if output_path is None:
        output_path = Path("literature/output/venue_distribution." + format)
...
def create_author_contributions_plot(
    ...
    if output_path is None:
        output_path = Path("literature/output/author_contributions." + format)
        output_path.parent.mkdir(parents=True, exist_ok=True)
...
def create_citation_distribution_plot(
    ...
    if output_path is None:
        output_path = Path("literature/output/citation_distribution." + format)
        output_path.parent.mkdir(parents=True, exist_ok=True)
...
def create_metadata_completeness_plot(
    ...
    if output_path is None:
        output_path = Path("literature/output/metadata_completeness." + format)
        output_path.parent.mkdir(parents=True, exist_ok=True)
