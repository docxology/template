...
def generate_text_summary(
    ...
    if output_path is None:
        output_path = Path("literature/output/meta_analysis_summary.md")
...
def export_summary_json(
    ...
    """
    if output_path is None:
        output_path = Path("literature/output/meta_analysis_summary.json")
    output_path = Path(output_path)
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def generate_all_summaries(
    ...
    Args:
        aggregator: Optional DataAggregator instance.
        output_dir: Output directory (defaults to literature/output).
        n_pca_components: Number of PCA components to analyze.
