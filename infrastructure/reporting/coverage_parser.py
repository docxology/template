...
def extract_timeout_errors(stdout: str, stderr: str) -> list[dict]:
    ...
    timeout_patterns = [
        r'timeout', r'pytest_timeout', r'TimeoutError',
        r'test.*timed out', r'exceeded.*timeout'
    ]
...
def extract_coverage_percentage(stdout_text: str, coverage_json_paths: list[Path], is_infra: bool = False) -> tuple[bool, Optional[float]]:
