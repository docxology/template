"""Codebase complexity and comparison dashboard charts.

Extracted from the former ``_dashboard_specialized.py`` monolith. This module is
responsible for codebase-metric visualizations only; health, pipeline, and
output charts live in sibling modules.
"""
