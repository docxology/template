...
def calculate_project_health_score(project: ProjectMetrics) -> Dict[str, Any]:
    ...
    if project.tests.total_tests > 0:
        ...
        if failure_rate == 0:
            ...
            factors["test_failures"] = {
                "score": 25,
                "grade": "B",
                "reason": f"Low failure rate {failure_rate:.1%}",
            }
            score += 25
            ...
            factors["test_failures"] = {
                "score": 20,
                "grade": "C",
                "reason": f"Moderate failure rate {failure_rate:.1%}",
            }
            score += 20
        else:
            factors["test_failures"] = {
    ...
    if project.manuscript.total_words >= 2000:
        factors["manuscript_size"] = {
            "score": 20,
            "grade": "A",
            "reason": f"Comprehensive manuscript ({project.manuscript.total_words} words)",
        }
        score += 20
        ...
        factors["manuscript_size"] = {
            "score": 15,
            "grade": "B",
            "reason": f"Good manuscript ({project.manuscript.total_words} words)",
        }
        score += 15
        ...
        factors["manuscript_size"] = {
            "score": 10,
            "grade": "C",
            "reason": f"Basic manuscript ({project.manuscript.total_words} words)",
        }
        score += 10
    else:
        factors["manuscript_size"] = {
    ...
    if outputs_generated >= 10:
        factors["outputs"] = {
            "score": 10,
            "grade": "A",
            "reason": f"Rich outputs ({outputs_generated} files)",
        }
        score += 10
        ...
        factors["outputs"] = {
            "score": 7,
            "grade": "B",
            "reason": f"Good outputs ({outputs_generated} files)",
        }
        score += 7
        ...
        factors["outputs"] = {
            "score": 4,
            "grade": "C",
            "reason": f"Basic outputs ({outputs_generated} files)",
        }
        score += 4
    else:
        factors["outputs"] = {
