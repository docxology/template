...
def write_last_run_summary(summary_lines: list[str], repo_root: Path) -> Path | None:
    ...
    try:
        ...
        artifact.write_text(
            "# Last Recorded Pipeline Run \u2014 Summary\n\n"
            "> Auto-generated by `infrastructure.reporting.multi_project_report.write_last_run_summary`. "
            "Do not edit manually. This receipt is historical evidence, not a current health claim; run the "
            "dedicated gates for current status.\n"
            f"> Generated: {stamp}\n\n"
            "```\n" + "\n".join(summary_lines) + "\n```\n"
        )
        return artifact
