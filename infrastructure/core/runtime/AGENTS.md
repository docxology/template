...
- `setup_checks.py` - Stage 0 orchestration: `sync_workspace_dependencies`, `validate_project_discovery`, `run_optional_setup_hook` (used by `scripts/00_setup_environment.py`)
- `eta.py` - ETA helpers
