...
class MissingDependencyError(DependencyError):
    ...
    def __init__(
        ...
        if recovery_commands is None and dependency:
            from infrastructure.core.environment import build_install_commands  # deferred: avoids cycle exceptions→environment→logging_utils→logging_helpers→exceptions
