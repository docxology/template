...
- 17 declared pipeline stages (8 core + 2 LLM + 3 opt-in ebook/docxplus/metadata + 2 opt-in bundle/archival + 2 opt-in science/provenance); default full runs execute 10 core+LLM stages; `--core-only` runs 8
