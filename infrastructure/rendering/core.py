...
class RenderManager:
    ...
    def render_all(self, source_file: Path) -> List[Path]:
        ...
        if source_file.suffix == '.tex':
            ...
            # Markdown supports Slides and Web
            outputs.append(self.slides_renderer.render(source_file, format="beamer"))
    ...
    def render_slides(self, source_file: Path, format: str = "beamer") -> Path:
        """Render slides."""
        return self.slides_renderer.render(source_file, format)
