...
- **Public repo confidentiality:** only the public exemplar set in [`infrastructure.project.public_scope.PUBLIC_PROJECT_NAMES`](../infrastructure/project/public_scope.py) may be git-tracked under `projects/` — [`scripts/audit/check_tracked_projects.py`](../scripts/audit/check_tracked_projects.py) enforces in CI and pre-push.
