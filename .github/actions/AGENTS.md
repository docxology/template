...
| [`setup-docs-lint/action.yml`](setup-docs-lint/action.yml) | Shared Node + Mermaid + Chrome provisioning for the two blocking documentation-lint callers and the textbook test matrix. |
