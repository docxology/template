...
| [`python-runtime-support.md`](python-runtime-support.md) | Supported-Python contract: `requires-python = ">=3.10"` floor, repository default from `.python-version` (currently 3.12), 3.13 readiness lane, and why dropping the floor needs a breaking release boundary | 2026-07-20 |
