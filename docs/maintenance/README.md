...
| [`private-projects-repo.md`](private-projects-repo.md) | Sibling private repo lifecycle (`active/`, `passive/`, `archive/`) and symlink-sync contract for confidential projects | 2026-05-21 |
...
- [`private-projects-repo.md`](private-projects-repo.md) — the implemented sibling private repo (active/passive/archive + active-link mechanism)
