...
* `projects/template_search_project/` — fully wired exemplar.
...
| Project | `projects/template_search_project/` | ~600 | included in suite |
...
* [`docs/audit/literature-modules-audit.md`](../audit/literature-modules-audit.md)
