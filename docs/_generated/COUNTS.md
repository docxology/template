...
(Last refreshed count: **758** on 2026-08-10 UTC — point-in-time; re-derive with the command above, the literal drifts as the tree changes.)
...
|---------|-----------------|----------------------------|
| `template_active_inference` | 898 | 92.51 % |
