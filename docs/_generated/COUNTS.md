...
| `template_autopoiesis` | 499 | 96.41 % |
...
| `template_gold_refinement` | 327 | 97.55 % |
| `template_literature_meta_analysis` | 884 | 96.74 % |
| `template_madlib` | 147 | 93.96 % |
| `template_methods_paper` | 87 | 98.97 % |
| `template_newspaper` | 136 | 94.37 % |
| `template_pitch_deck` | 112 | 97.70 % |
| `template_pools_rules_tools` | 261 | 95.52 % |
| `template_prose_project` | 120 | 100.00 % |
| `template_redacted_report` | 110 | 98.83 % |
| `template_registered_report` | 33 | 96.37 % |
| `template_search_project` | 298 | 95.13 % |
| `template_sia` | 66 | 97.16 % |
| `template_storybook` | 10 | 93.92 % |
| `template_template` | 138 | 99.37 % |
