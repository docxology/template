...
```yaml
- uses: astral-sh/setup-uv@c771a70e6277c0a99b617c7a806ffedaca235ff9 # v9.0.0      # installs uv in CI
  with:
    enable-cache: true
...
This workflow runs infrastructure tests on Ubuntu across Python 3.10–3.14 and on macOS with Python 3.14. See [.github/workflows/ci.yml](../.github/workflows/ci.yml) for the full matrix and job definitions.
