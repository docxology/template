...
| File | Purpose |
|------|---------|
| `modules-guide.md` | Overview table (19 rows: 17 importable packages + Telemetry sub-row + Config/Docker config dirs; links into `guides/` plus hub AGENTS for Orchestration, Prose, Search, Reference) |
