...
**Quick Reference:** [Common Workflows](COMMON_WORKFLOWS.md) | [Troubleshooting Guide](TROUBLESHOOTING_GUIDE.md) | [Version Control](VERSION_CONTROL.md)
...
4. **Rebuild outputs** - `./repo_utilities/render_pdf.sh`
...
- [Version Control](VERSION_CONTROL.md) - Git workflows
- [Troubleshooting Guide](TROUBLESHOOTING_GUIDE.md) - Recovery troubleshooting
- [Common Workflows](COMMON_WORKFLOWS.md) - Backup workflows

---

**Related Documentation:**
- [Version Control](VERSION_CONTROL.md) - Git backup strategies
