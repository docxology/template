...
**New to the template?** Start with **[Quick Start Cheatsheet](../reference/quick-start-cheatsheet.md)** | **[Getting Started](../guides/getting-started.md)**
...
1. **Determine section number**
   ...
   - See [Manuscript Numbering](../usage/manuscript-numbering-system.md)
...
- Wrong order? See [Manuscript Numbering](../usage/manuscript-numbering-system.md)
...
**See Also**: [Manuscript Numbering](../usage/manuscript-numbering-system.md)
...
- **[Quick Start Cheatsheet](../reference/quick-start-cheatsheet.md)** - One-page reference
- **[Getting Started](../guides/getting-started.md)** - beginner guide
...
**Need more help?** Check the **[FAQ](../reference/faq.md)** or **[Documentation Index](../documentation-index.md)**
