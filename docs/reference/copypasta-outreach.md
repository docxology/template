# 📋 Copypasta — Outreach & Marketing Templates

> **Pre-written content** for sharing the Research Project Template on social media, forums, and email

**See also:** [Copypasta — Descriptions & Code](copypasta.md) | [Copypasta — Diagrams](copypasta-diagrams.md)
...
**Related:** [Copypasta — Descriptions & Code](copypasta.md) | [Copypasta — Diagrams](copypasta-diagrams.md)
