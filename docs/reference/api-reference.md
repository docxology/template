...
The per-package symbol listings below are generated between the
`BEGIN:API_REFERENCE` and `END:API_REFERENCE` markers by
`scripts/docgen/api_reference.py`. Do not edit the generated block by hand.
<!-- BEGIN:API_REFERENCE -->
