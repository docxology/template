...
- **Manuscript examples**: default to [`projects/template_code_project/manuscript/`](../../projects/template_code_project/manuscript/); active `projects/` names → [_generated/active_projects.md](../_generated/active_projects.md).
