...
uv run pytest projects/templates/template_code_project/tests/test_file.py -vv

# Run specific test
uv run pytest projects/templates/template_code_project/tests/test_file.py::test_function -v
...
```bash
# Run with debugger
uv run pytest projects/templates/template_code_project/tests/test_file.py::test_function --pdb
