...
```bash
# Run single test
uv run pytest projects/template_code_project/tests/test_example.py::test_add_numbers -v
...
uv run pytest projects/template_code_project/tests/test_file.py -vv

# Run specific test
uv run pytest projects/template_code_project/tests/test_file.py::test_function -v
...
```bash
# Run with debugger
uv run pytest projects/template_code_project/tests/test_file.py::test_function --pdb

# Run with verbose output
uv run pytest projects/template_code_project/tests/test_file.py::test_function -vv -s

# Check specific module coverage
uv run pytest projects/template_code_project/tests/test_file.py --cov=projects.template_code_project.src.module_name --cov-report=term-missing
