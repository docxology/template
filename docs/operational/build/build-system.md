...
| Manuscript outputs (figures / PDFs / HTML / slides counts) | `projects/template_code_project/docs/output_inventory.md` or per-project `output/` inventories |
...
3. Run scripts individually: `uv run python projects/template_code_project/scripts/optimization_analysis.py`
