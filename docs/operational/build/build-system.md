...
# - All tests pass — live counts → docs/_generated/canonical_facts.md
...
- ✅ **All tests passing** — live counts → [`docs/_generated/canonical_facts.md`](../../_generated/canonical_facts.md)
