...
**Quick Reference:** [How To Use](../core/how-to-use.md) | [Two-Layer Architecture](../architecture/two-layer-architecture.md) | [Workflow](../core/workflow.md) | [Thin Orchestrator Summary](../architecture/thin-orchestrator-summary.md)
...
- **[Two-Layer Architecture](../architecture/two-layer-architecture.md)** - guide to Layer 1 (Infrastructure) vs Layer 2 (Project) separation
- **[Thin Orchestrator Pattern](../architecture/thin-orchestrator-summary.md)** - Detailed implementation of the thin orchestrator pattern
...
- **[`thin-orchestrator-summary.md`](../architecture/thin-orchestrator-summary.md)** - Thin orchestrator pattern implementation
...
graph TB
    ...
    class INFRA,PROJECT,TESTS,SCRIPTS,MD,MANUSCRIPT core
    class PROJECT,SCRIPTS pattern
...
- `infrastructure/reporting/` - Pipeline reporting and metrics
- `infrastructure/scientific/` - Scientific dev tools
- `infrastructure/project/` - Project discovery and orchestration
...
- **`tests/`** and **`projects/{name}/tests/`** ensure coverage of project functionality
- **`scripts/execute_pipeline.py`** orchestrates the entire 8-stage pipeline (stages 00-07)
...
- **[`two-layer-architecture.md`](../architecture/two-layer-architecture.md)** - two-layer architecture guide
