...
| **fetch** | Retrieve corpus / run analysis to produce figures + data | [`../../scripts/pipeline/stage_02_analysis.py`](../../scripts/pipeline/stage_02_analysis.py); `run_matrix.py` stage `analysis` | [`literature-synthesis/SKILL.md`](literature-synthesis/SKILL.md) |
...
| **write** | Draft / outline / revise the manuscript | scaffold via [`../guides/new-project-one-shot-prompt.md`](../guides/new-project-one-shot-prompt.md); render [`../../scripts/pipeline/stage_03_render.py`](../../scripts/pipeline/stage_03_render.py); `run_matrix.py` stage `render_pdf` | [`academic-paper/SKILL.md`](academic-paper/SKILL.md), [`manuscript-creation/SKILL.md`](manuscript-creation/SKILL.md) |
...
| **review** | Peer / methodology review of the draft | [`../../scripts/pipeline/stage_06_llm_review.py`](../../scripts/pipeline/stage_06_llm_review.py) `--reviews-only`; `run_matrix.py` stage `llm_reviews` | [`academic-paper-reviewer/SKILL.md`](academic-paper-reviewer/SKILL.md) |
| **validate** | Quality gates on PDFs and outputs | [`../../scripts/pipeline/stage_04_validate.py`](../../scripts/pipeline/stage_04_validate.py); `uv run python -m infrastructure.validation.cli pdf <pdf>`; `run_matrix.py` stage `validate` | [`validation-quality/SKILL.md`](validation-quality/SKILL.md) |
| **publish** | Copy deliverables, bundle, archive, mint DOI | [`../../scripts/pipeline/stage_05_copy.py`](../../scripts/pipeline/stage_05_copy.py) (`copy`), [`../../scripts/runner/bundle_executable.py`](../../scripts/runner/bundle_executable.py), [`../../scripts/runner/archive_publication.py`](../../scripts/runner/archive_publication.py); `python -m infrastructure.orchestration secure` | [`reproducibility-audit/SKILL.md`](reproducibility-audit/SKILL.md) |
