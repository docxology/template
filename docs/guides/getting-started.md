...
**Quick Reference:** [Cheatsheet](../reference/quick-start-cheatsheet.md) | [Common Workflows](../reference/common-workflows.md) | [FAQ](../reference/faq.md)
...
→ Read **[Examples Showcase](../usage/examples-showcase.md)**
...
**Congratulations!** You've mastered the basics. Ready for more? Check out **[Figures and Analysis](../guides/figures-and-analysis.md)**.
