...
3. **Archived project references**: References to archived projects which may be outdated
...
1. **`.cursorrules/` references**: Many files reference `.cursorrules/` files that may not exist
   - Example: `docs/documentation-index.md` references multiple `.cursorrules/` files
...
- `docs/documentation-index.md` - Multiple instances
...
3. **Fixed .cursorrules/ references** ✅
   - Updated path references in docs/documentation-index.md and docs/AGENTS.md
...
4. **Fixed anchor links** ✅
   ...
   - Fixed links to build-system.md sections
...
1. **Update archived project references** (Optional)
   - Some references to archived projects may be outdated
