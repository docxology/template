...
🚨 **345 issues** found across 3 categories.

### Issues by Category

- **Broken File Refs:** 2 issues
- **Code Block Paths:** 282 issues
...
### Broken File References (2 issues)
...
**2.** `projects/ento_linguistics/.venv/lib/python3.12/site-packages/nltk-3.9.2.dist-info/licenses/README.md:15`
- **Target:** `CONTRIBUTING.md`
...
### Invalid Code Block Paths (282 issues)

File paths in code examples that don't exist

**1.** `/Users/4d/Documents/GitHub/template/AGENTS.md:908`
- **Target:** `scripts/)`
- **Issue:** File path in code block does not exist: scripts/)

**2.** `/Users/4d/Documents/GitHub/template/AGENTS.md:2149`
- **Target:** `scripts/``
- **Issue:** File path in code block does not exist: scripts/`

**3.** `/Users/4d/Documents/GitHub/template/README.md:532`
- **Target:** `infrastructure/\nGeneric`
- **Issue:** File path in code block does not exist: infrastructure/\nGeneric

**4.** `/Users/4d/Documents/GitHub/template/README.md:588`
- **Target:** `infrastructure/AGENTS.md]`
- **Issue:** File path in code block does not exist: infrastructure/AGENTS.md]

**5.** `/Users/4d/Documents/GitHub/template/README.md:636`
- **Target:** `scripts/\nEntry`
- **Issue:** File path in code block does not exist: scripts/\nEntry

**6.** `/Users/4d/Documents/GitHub/template/README.md:710`
- **Target:** `scripts/AGENTS.md]`
- **Issue:** File path in code block does not exist: scripts/AGENTS.md]

**7.** `/Users/4d/Documents/GitHub/template/README.md:1019`
- **Target:** `scripts/\nAnalysis`
- **Issue:** File path in code block does not exist: scripts/\nAnalysis

**8.** `/Users/4d/Documents/GitHub/template/README.md:1086`
- **Target:** `scripts/AGENTS.md]`
- **Issue:** File path in code block does not exist: scripts/AGENTS.md]

**9.** `/Users/4d/Documents/GitHub/template/README.md:893`
- **Target:** `projects/project/src/\nScientific`
- **Issue:** File path in code block does not exist: projects/project/src/\nScientific

**10.** `/Users/4d/Documents/GitHub/template/README.md:954`
- **Target:** `projects/project/src/AGENTS.md]`
- **Issue:** File path in code block does not exist: projects/project/src/AGENTS.md]

*... and 272 more issues in this category*
