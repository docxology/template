...
**Files Scanned:** 329
**Total Issues:** 378
**Scan Duration:** 0.51 seconds

## 📈 Executive Summary

🚨 **378 issues** found across 4 categories.

### Issues by Category

- **Broken Anchor Links:** 20 issues
- **Broken File Refs:** 3 issues
- **Code Block Paths:** 294 issues
- **Cross Reference Issues:** 61 issues
...
### Invalid Code Block Paths (294 issues)

File paths in code examples that don't exist

**1.** `/Users/4d/Documents/GitHub/template/.cursorrules/documentation_standards.md:721`
- **Target:** `infrastructure/AGENTS.md)`
- **Issue:** File path in code block does not exist: infrastructure/AGENTS.md)

**2.** `/Users/4d/Documents/GitHub/template/.cursorrules/documentation_standards.md:421`
...
**3.** `/Users/4d/Documents/GitHub/template/.cursorrules/documentation_standards.md:440`
- **Target:** `infrastructure/AGENTS.md)`
- **Issue:** File path in code block does not exist: infrastructure/AGENTS.md)

**4.** `/Users/4d/Documents/GitHub/template/.cursorrules/folder_structure.md:92`
- **Target:** `infrastructure/module/`
- **Issue:** File path in code block does not exist: infrastructure/module/

**5.** `/Users/4d/Documents/GitHub/template/.cursorrules/testing_standards.md:476`
- **Target:** `infrastructure/test_core/test_basic.py`
- **Issue:** File path in code block does not exist: infrastructure/test_core/test_basic.py

**6.** `/Users/4d/Documents/GitHub/template/.cursorrules/testing_standards.md:569`
- **Target:** `infrastructure/test_core/test_basic.py::test_validation_passes`
- **Issue:** File path in code block does not exist: infrastructure/test_core/test_basic.py::test_validation_passes

**7.** `/Users/4d/Documents/GitHub/template/.cursorrules/type_hints_standards.md:530`
- **Target:** `infrastructure/core.py`
- **Issue:** File path in code block does not exist: infrastructure/core.py

**8.** `/Users/4d/Documents/GitHub/template/.github/workflows/README.md:458`
- **Target:** `scripts/custom_check.py`
- **Issue:** File path in code block does not exist: scripts/custom_check.py

**9.** `/Users/4d/Documents/GitHub/template/.github/workflows/README.md:393`
- **Target:** `scripts/extra_checks.py`
- **Issue:** File path in code block does not exist: scripts/extra_checks.py

**10.** `/Users/4d/Documents/GitHub/template/AGENTS.md:908`
- **Target:** `scripts/)`
- **Issue:** File path in code block does not exist: scripts/)

*... and 284 more issues in this category*
...
**9.** `.cursorrules/AGENTS.md:415`
- **Target:** `../projects/project/manuscript/AGENTS.md`
- **Issue:** Invalid AGENTS.md reference: ../projects/project/manuscript/AGENTS.md
- **Text:** project/manuscript/AGENTS.md

**10.** `.cursorrules/AGENTS.md:436`
- **Target:** `../infrastructure/AGENTS.md`
- **Issue:** Invalid AGENTS.md reference: ../infrastructure/AGENTS.md
- **Text:** ../infrastructure/AGENTS.md

*... and 51 more issues in this category*
