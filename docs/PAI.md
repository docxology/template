...
- **Version**: Default [`pipeline.yaml`](../infrastructure/core/pipeline/pipeline.yaml) is authoritative. Declared / default-full / `--core-only` counts live in the generated `STAGE_SUMMARY` in [`RUN_GUIDE.md`](RUN_GUIDE.md).
