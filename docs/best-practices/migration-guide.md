...
**Quick Reference:** [Getting Started](../guides/getting-started.md) | [Architecture](../core/architecture.md) | [Common Workflows](../reference/common-workflows.md)
...
# Run new build
cd new_project && uv run python scripts/runner/execute_pipeline.py --project {name} --core-only
...
- [Common Workflows](../reference/common-workflows.md) - Step-by-step guides
