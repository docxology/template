...
- **Project paths**: exemplar [`projects/templates/template_code_project/`](../../projects/templates/template_code_project/); authoritative active list → [_generated/active_projects.md](../_generated/active_projects.md).
