...
- **Project paths**: exemplar [`projects/template_code_project/`](../../projects/template_code_project/); authoritative active list → [_generated/active_projects.md](../_generated/active_projects.md).
