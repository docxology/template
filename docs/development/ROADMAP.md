...
For current implementation details, see **[`THIN_ORCHESTRATOR_SUMMARY.md`](../architecture/THIN_ORCHESTRATOR_SUMMARY.md)** and **[`EXAMPLES_SHOWCASE.md`](../usage/EXAMPLES_SHOWCASE.md)**.
