...
The template ships with 100+ documentation files under `docs/`. The full
hierarchical map (with mermaid diagram) lives in
[`docs/AGENTS.md`](docs/AGENTS.md); the per-file index lives in
[`docs/documentation-index.md`](docs/documentation-index.md). Top-level layout:
...
`config.yaml`, `preamble.md`, `01_abstract.md` … `06_conclusion.md`,
`S01_*.md` (supplemental), `98_symbols_glossary.md` (auto-generated),
`99_references.md`. Numbering system and slug rules:
...
The full per-file documentation index (≈90 entries) lives in
[`docs/documentation-index.md`](docs/documentation-index.md). Top-level entry points:
