...
class TestGenerateSyntheticData:
    ...
    def test_uniform_distribution(self):
        ...
        data = generate_synthetic_data(100, distribution="uniform", low=0, high=10, seed=42)
        assert data.shape == (100, 1)
    ...
    def test_exponential_distribution(self):
        ...
        data = generate_synthetic_data(100, distribution="exponential", scale=1.0, seed=42)
        assert data.shape == (100, 1)
        assert np.all(data >= 0)
...
class TestGenerateTimeSeries:
    ...
    def test_quadratic_trend(self):
        ...
        time, values = generate_time_series(100, trend="quadratic", a=0.1, b=1.0, c=0.0, seed=42)
        assert len(time) == 100
        assert len(values) == 100
