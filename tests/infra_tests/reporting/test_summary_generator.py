...
class TestLoadTestResults:
    ...
    def test_returns_empty_dict_when_file_missing(self, tmp_path):
        ...
        result = load_test_results("nonexistent_project", tmp_path)
        assert result == {}

    def test_loads_nested_project_key(self, tmp_path):
    ...
    def test_loads_flat_structure(self, tmp_path):
...
class TestGenerateSummaryReport:
    ...
    def test_returns_dict_with_required_keys(self, tmp_path):
        ...
        result = generate_summary_report(tmp_path)
    ...
    def test_summary_aggregates_totals(self, tmp_path):
