...
The `tests/infra_tests/reporting/` directory contains tests for the pipeline reporting and error aggregation infrastructure. These tests validate the reporting system's ability to generate consolidated pipeline reports, test results, and validation summaries.
