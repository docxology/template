...
class TestDiscoverMarkdownFilesFromDocsDiscovery:
    def test_finds_md_files(self, tmp_path):
...
class TestFindMarkdownFilesFromDocsDiscovery:
...
class TestCatalogAgentsReadmeFromDocsDiscovery:
...
class TestFindConfigFilesFromDocsDiscovery:
...
class TestFindScriptFilesFromDocsDiscovery:
    def test_finds_scripts_in_scripts_dir(self, tmp_path):
...
class TestCreateHierarchyFromDocsDiscovery:
...
class TestIdentifyCrossReferencesFromDocsDiscovery:
...
class TestAnalyzeDocumentationFileFromDocsDiscovery:
