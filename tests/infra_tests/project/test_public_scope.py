...
def test_public_scope_filters_to_template_projects(tmp_path: Path) -> None:
    ...
    _scaffold_project(tmp_path, "template_active_inference")
    _scaffold_project(tmp_path, "template_autoresearch_project")
    ...
    assert public_ci_source_paths(tmp_path) == [
        Path("infrastructure"),
        Path("projects/template_active_inference/src"),
        Path("projects/template_autoresearch_project/src"),
