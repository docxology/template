...
class TestValidateSectionCompletenessFromValidationStructure:
...
class TestExtractStructuredSectionsFromValidationStructure:
...
class TestValidateResponseStructureFromValidationStructure:
