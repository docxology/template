...
Covers has_generated_manuscript_ordering and load_project_config_yaml.
"""
...
# ---------------------------------------------------------------------------
# has_generated_manuscript_ordering / load_project_config_yaml
# ---------------------------------------------------------------------------
...
def test_has_generated_manuscript_ordering(tmp_path: Path, config_text: str, expected: bool) -> None:
    ...
    assert has_generated_manuscript_ordering(cfg) is expected


def test_has_generated_manuscript_ordering_missing_file(tmp_path: Path) -> None:
    assert has_generated_manuscript_ordering(tmp_path / "missing.yaml") is False
...
def test_load_project_config_yaml_missing_file(tmp_path: Path) -> None:
    ...
    assert load_project_config_yaml(manuscript_dir) is None
...
def test_load_project_config_yaml_valid_dict(tmp_path: Path) -> None:
    ...
    loaded = load_project_config_yaml(manuscript_dir)
