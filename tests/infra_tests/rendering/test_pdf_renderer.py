"""Canonical tests for infrastructure.rendering.pdf_renderer.

Edge-case coverage, integration paths, and renderer dispatch using real files
...
class TestCombineMarkdownFilesErrors:
    ...
    def test_combine_with_unicode_error(self, renderer, tmp_path):
        ...
        with pytest.raises(RenderingError, match="encoding"):
            combine_manuscript_markdown_sections([md_file])
    ...
    def test_combine_validates_header_attributes(self, renderer, tmp_path):
        ...
        result = combine_manuscript_markdown_sections([md_file])
...
class TestCombineMarkdownFilesEdgeCases:
    ...
    def test_combine_multiple_files_with_page_breaks(self, renderer, tmp_path):
        ...
        result = combine_manuscript_markdown_sections([file1, file2])
...
class TestLatexCompilationFromPdfRenderer:
...
class TestPandocIntegrationFromPdfRenderer:
...
class TestRenderOptionsFromPdfRenderer:
...
class TestPdfRendererIntegrationFromPdfRenderer:
    """Integration tests for PDF renderer."""
