...
class TestBuildPandocRenderError:
    ...
    def test_basic_error_no_output(self, tmp_path):
        ...
        result = build_pandoc_render_error(e, combined_md, [combined_md], "", ["pandoc", "--to=latex"])
    ...
    def test_error_with_stderr(self, tmp_path):
        ...
        e = self._make_error(stderr="Error at line 5: unbalanced parenthesis at position 42\n")
        result = build_pandoc_render_error(e, combined_md, [combined_md], "", ["pandoc", "--to=latex"])
        assert isinstance(result, RenderingError)
    ...
    def test_error_with_position_info(self, tmp_path):
        ...
        e = self._make_error(stderr="error: unbalanced parenthesis at position 50\n")
        result = build_pandoc_render_error(e, combined_md, [combined_md], content, ["pandoc", "--to=latex"])
        assert isinstance(result, RenderingError)
    ...
    def test_error_with_multiple_source_files(self, tmp_path):
        ...
        e = self._make_error(stderr="error: unbalanced parenthesis at position 40\n")
        result = build_pandoc_render_error(e, combined_md, [file1, file2], combined_content, ["pandoc", "--to=latex"])
        assert isinstance(result, RenderingError)
    ...
    def test_error_nonexistent_combined_md(self, tmp_path):
        ...
        result = build_pandoc_render_error(e, combined_md, [], "", ["pandoc", "--to=latex"])
        assert isinstance(result, RenderingError)
    ...
    def test_error_suggestions_include_pandoc_command(self, tmp_path):
        ...
        result = build_pandoc_render_error(e, combined_md, [combined_md], "x", pandoc_cmd)
    ...
    def test_error_with_unbalanced_parenthesis_suggestions(self, tmp_path):
        ...
        e = self._make_error(stderr="Error: unbalanced parenthesis at position 5\n")
        result = build_pandoc_render_error(e, combined_md, [combined_md], "test (unbalanced content", ["pandoc"])
    ...
    def test_error_context_includes_source_and_target(self, tmp_path):
        ...
        result = build_pandoc_render_error(e, combined_md, [], "", ["pandoc"])
    ...
    def test_error_md_content_passed_as_empty(self, tmp_path):
        ...
        e = self._make_error(stderr="error at position 5\n")
        result = build_pandoc_render_error(e, combined_md, [combined_md], "", ["pandoc"])
    ...
    def test_error_with_both_stderr_and_stdout(self, tmp_path):
        ...
        result = build_pandoc_render_error(e, combined_md, [combined_md], "content", ["pandoc"])
    ...
    def test_error_position_near_file_boundary(self, tmp_path):
        ...
        e = self._make_error(stderr="error: unbalanced parenthesis at position 1\n")
        result = build_pandoc_render_error(e, combined_md, [combined_md], content, ["pandoc"])
    ...
    def test_error_line_number_computation(self, tmp_path):
        ...
        e = self._make_error(stderr="error: unbalanced parenthesis at position 12\n")
        result = build_pandoc_render_error(e, combined_md, [combined_md], content, ["pandoc"])
