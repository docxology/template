...
flowchart TB
    ...
    INFRA_T --> INFRA_SUB[audit · autoresearch · benchmark · config · core · doctor ·<br/>documentation · fonds · gates · git_hook_smoke · llm · methods ·<br/>orchestration · pipeline · project · prose · provenance · publishing ·<br/>regression · reference · rendering · reporting · research · rules ·<br/>scientific · search · sia · skills · steganography · tools ·<br/>validation]
