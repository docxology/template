...
# Run with coverage
pytest tests/infrastructure/core/ --cov=infrastructure.core --cov-report=term
```
...
```bash
pytest tests/infrastructure/core/test_logging*.py -v
```
...
```bash
pytest tests/infrastructure/core/test_exceptions.py -v
```
...
```bash
pytest tests/infrastructure/core/test_file_operations.py -v
```
...
pytest tests/infrastructure/core/test_config_loader.py::test_load_config -v

# Test specific class
pytest tests/infrastructure/core/test_exceptions.py::TestTemplateError -v
```
...
pytest tests/infrastructure/core/test_config_loader.py::test_config_with_logging -v
```
...
```bash
# Test error handling
pytest tests/infrastructure/core/ -k "error" -v
```
...
pytest tests/infrastructure/core/test_config*.py -v
...
```bash
pytest tests/infrastructure/core/ -vv -s
```

### Last Failed

```bash
pytest tests/infrastructure/core/ --lf
```

### Stop on First Failure

```bash
pytest tests/infrastructure/core/ -x
```
