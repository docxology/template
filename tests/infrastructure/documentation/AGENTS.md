...
pytest tests/infrastructure/documentation/test_glossary_gen.py

# Run with coverage
pytest tests/infrastructure/documentation/ --cov=infrastructure.documentation --cov-report=html
```
...
```bash
# Debug specific test
pytest tests/infrastructure/documentation/test_glossary_gen.py::test_api_extraction -v -s

# Profile test performance
pytest tests/infrastructure/documentation/ --durations=5
```
