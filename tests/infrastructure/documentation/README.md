...
pytest tests/infrastructure/documentation/ -v

# Run specific test module
pytest tests/infrastructure/documentation/test_figure_manager.py -v
```
...
```bash
pytest tests/infrastructure/documentation/test_image_manager.py -v
```
...
```bash
pytest tests/infrastructure/documentation/test_glossary_gen.py -v
```
...
pytest tests/infrastructure/documentation/test_figure_manager.py::test_register_figure -v
```
...
pytest tests/infrastructure/documentation/test_glossary_gen.py::test_generate_glossary -v
```
...
```bash
pytest tests/infrastructure/documentation/ \
