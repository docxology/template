...
pytest tests/infrastructure/reporting/test_error_aggregator.py -v
```
...
```bash
pytest tests/infrastructure/reporting/test_pipeline_report.py -v
```
...
pytest tests/infrastructure/reporting/test_error_aggregator.py::test_aggregate_errors -v
```
...
pytest tests/infrastructure/reporting/test_pipeline_report.py::test_full_pipeline -v
```
