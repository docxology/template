...
def sample_projects():
    ...
    project2 = ProjectMetrics(
        ...
        tests=TestMetrics(total_tests=80, passed=75, failed=5, coverage_percent=92.0, execution_time=8.0),
...
def sample_aggregate():
    ...
    return {
        ...
        'outputs': {'total_pdfs': 9, 'total_size_mb': 3.5, 'total_figures': 9, 'total_slides': 18, 'total_web': 3},
...
class TestChartGeneration:
    ...
    def test_create_output_distribution_chart_empty(self):
        ...
        empty_aggregate = {'outputs': {'total_pdfs': 0, 'total_figures': 0, 'total_slides': 0, 'total_web': 0}}
...
class TestMatplotlibDashboard:
    ...
    def test_generate_matplotlib_dashboard_single_project(self, tmp_path):
        ...
        summary = ExecutiveSummary(
            timestamp="2025-12-28T10:00:00",
            total_projects=1,
            aggregate_metrics={'manuscript': {}, 'codebase': {}, 'tests': {}, 'outputs': {}, 'pipeline': {}},
