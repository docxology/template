...
pytest tests/infrastructure/publishing/ -v

# Run API tests
pytest tests/infrastructure/publishing/test_api.py -v

# Run CLI tests
pytest tests/infrastructure/publishing/test_cli.py -v
```
...
```bash
pytest tests/infrastructure/publishing/test_publishing.py -v
```
...
pytest tests/infrastructure/publishing/test_publishing.py::test_extract_metadata -v

# Test citation generation
pytest tests/infrastructure/publishing/test_publishing.py::test_generate_citation -v
```
...
pytest tests/infrastructure/publishing/test_publishing_api_full.py -v
```
...
pytest tests/infrastructure/publishing/test_publishing_edge_cases.py -v
```
...
```bash
pytest tests/infrastructure/publishing/ -vv -s
```
