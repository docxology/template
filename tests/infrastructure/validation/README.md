...
pytest tests/infrastructure/validation/test_pdf_validator.py -v
```
...
```bash
pytest tests/infrastructure/validation/test_markdown_validator.py -v
```
...
```bash
pytest tests/infrastructure/validation/test_integrity.py -v
```
...
```bash
# Test PDF validation
pytest tests/infrastructure/validation/test_pdf_validator.py::test_validate_pdf -v
```
...
pytest tests/infrastructure/validation/test_integrity.py::test_full_integrity_check -v
```
...
```bash
# PDF tests only
pytest tests/infrastructure/validation/test_pdf*.py -v

# Markdown tests only
pytest tests/infrastructure/validation/test_markdown*.py -v
