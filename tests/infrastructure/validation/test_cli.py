...
class TestValidatePdfCommand:
    ...
    def test_pdf_validation_non_verbose(self, tmp_path, caplog):
        ...
        assert "Validating PDF" in caplog.text
...
class TestVerifyIntegrityCommand:
    ...
    def test_valid_output_dir_non_verbose(self, tmp_path, capsys, caplog):
