...
class TestValidateMarkdownCommand:
    ...
    def test_markdown_command_nonexistent_dir(self, tmp_path, caplog):
        ...
        assert "not found" in caplog.text.lower() or "directory" in caplog.text.lower()
    ...
    def test_markdown_command_without_repo_root(self, tmp_path):
        ...
        args = argparse.Namespace(markdown_dir=str(tmp_path), repo_root=None)
...
class TestVerifyIntegrityCommand:
    ...
    def test_integrity_command_with_valid_dir(self, tmp_path):
        ...
        args = argparse.Namespace(output_dir=str(tmp_path), verbose=False)
    ...
    def test_integrity_command_verbose(self, tmp_path):
        ...
        args = argparse.Namespace(output_dir=str(tmp_path), verbose=True)
