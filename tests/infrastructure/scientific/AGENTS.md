...
```
tests/infrastructure/scientific/
...
pytest tests/infrastructure/scientific/test_stability.py

# Run performance benchmarking tests
pytest tests/infrastructure/scientific/test_benchmarking.py

# Run with performance profiling
pytest tests/infrastructure/scientific/ --durations=10
```
...
pytest tests/infrastructure/scientific/ -k "benchmark or performance"

# Run with memory profiling
pytest tests/infrastructure/scientific/ --memray

# Run scalability tests
pytest tests/infrastructure/scientific/ -k "scalability"
```
