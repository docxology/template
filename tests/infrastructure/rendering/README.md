...
pytest tests/infrastructure/rendering/test_pdf_renderer*.py -v
```
...
```bash
pytest tests/infrastructure/rendering/test_html_renderer.py -v
```
...
```bash
pytest tests/infrastructure/rendering/test_slides_renderer.py -v
```
...
```bash
# Test PDF generation
pytest tests/infrastructure/rendering/test_pdf_renderer_combined.py::test_render_combined_pdf -v
```
...
pytest tests/infrastructure/rendering/test_pdf_renderer_combined.py::test_full_pipeline -v
```
...
```bash
# PDF tests only
pytest tests/infrastructure/rendering/test_pdf*.py -v

# HTML tests only
pytest tests/infrastructure/rendering/test_html*.py -v

# Slide tests only
pytest tests/infrastructure/rendering/test_slides*.py -v
```

### With Coverage

```bash
pytest tests/infrastructure/rendering/ \
...
```bash
pytest tests/infrastructure/rendering/ -vv -s
```
