...
class TestBeamerSlides:
    ...
    def test_render_beamer_exists(self):
        ...
        assert hasattr(slides_renderer, 'render_beamer') or \
               hasattr(slides_renderer, 'render_beamer_slides') or \
...
class TestRevealJsSlides:
    ...
    def test_render_revealjs_exists(self):
        ...
        assert hasattr(slides_renderer, 'render_revealjs') or \
               hasattr(slides_renderer, 'render_reveal_slides') or \
               hasattr(slides_renderer, 'SlidesRenderer')
