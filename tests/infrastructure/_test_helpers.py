...
These functions are imported by conftest.py and can be used directly
in tests. All functions follow the 'no mocks' policy and create real
data for testing.

Available helpers:
- create_project_config_structure: Create standard project layout
- create_sample_config_data: Generate sample configuration data
- write_config_file: Write YAML config files
- create_output_directory_structure: Create output subdirectories
- create_pdf_file: Create real PDF files for testing
- create_output_with_pdf: Create complete output structure with PDF
- create_test_manuscript_files: Create sample manuscript sections
