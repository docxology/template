...
- Default slug is `template_test`: a stable, readable stand-in that does not couple tests to the public exemplars listed in [`docs/_generated/active_projects.md`](../../docs/_generated/active_projects.md).
