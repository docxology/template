...
\begin{frame}{The 1797 Bank Restriction and the Suspension of Metallic
Reality}
\protect\phantomsection\label{sec-bank-restriction-1797}
...
{[}@clapham1944bank{]}. The Bank's reserves had declined by £622,000
...
{[}@fetter1965development{]}. This legislation legally suspended the
...
\begin{block}{The Atomic Swerve: Fiat Currency and Forgery's Media
Ecology}
\protect\phantomsection\label{the-atomic-swerve-fiat-currency-and-forgerys-media-ecology}
...
ecology'' {[}@makdisi2003william{]}. Paper money ceased to be an elite
...
{[}@bentley2004records{]}). The historical irony is profound: the
...
Bank's groundless, easily forged monopoly {[}@baucom2005specters;
@erdman1954prophet; @crosby2011blake{]}.
...
(Plate 5, lines 1--3; Erdman p.~63) {[}@erdman1988complete{]}. This
...
{[}@thornton1802nature{]}. The everyday economy, once rooted in the
...
restriction era {[}@clapham1944bank;
@tooke1838history{]}.}\label{fig-historic-reserves}
\end{figure}
\end{block}

\begin{block}{Blake's \emph{Vala} and the Ontology of Paper Credit: The
Paper Epic}
\protect\phantomsection\label{blakes-vala-and-the-ontology-of-paper-credit-the-paper-epic}
...
substantive present reality {[}@brantlinger1996fictions;
@tooke1838history{]}. Ian Baucom extends this critique in his study of
finance capital and the Atlantic slave trade, demonstrating how this era
of British credit relied on an epistemology of ``spectral value,''
wherein human life itself became fully fungible and exchangeable on
international ledgers {[}@baucom2005specters{]}. It was the total
atomization of social value into swerving, groundless paper contracts,
fractional reserve banking, and what Blake elsewhere termed ``allegoric
riches'' (Plate 27, \emph{Jerusalem}) {[}@makdisi2003william;
@erdman1988complete{]}.
...
wartime scarcity {[}@ricardo1810high{]}. The resulting Bullionist
Controversy (explored in \hyperlink{sec-bullionist-controversy}{§ The
