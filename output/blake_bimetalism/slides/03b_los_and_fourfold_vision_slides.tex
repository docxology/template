...
\begin{frame}{Blake's Fourfold Vision and the Scales of Monetary
Generation}
\protect\phantomsection\label{sec-four-levels-vision}
...
\begin{block}{Single Vision of Ulro: Atomized Monometallism and Fiat
Currency}
\protect\phantomsection\label{single-vision-of-ulro-atomized-monometallism-and-fiat-currency}
...
\hyperlink{sec-coinage-act-1816}{§ The 1816 Coinage Act}). The 1816
...
circulation, constituted a semiotic void {[}@clapham1944bank{]}. It
...
\begin{block}{Twofold Vision of Generation: The Dialectic of Structural
Bimetallism}
\protect\phantomsection\label{twofold-vision-of-generation-the-dialectic-of-structural-bimetallism}
...
two'' {[}@fuller1975synergetics{]}---a structural necessity Blake
...
{[}@delmar1895history{]}. The instability is not a flaw but a
feature---it is the generative friction of two irreducible principles in
dialogue, the very condition of creative evolution.
\end{block}

\begin{block}{Threefold Vision of Beulah: The Affective and
Psychological Threshold}
\protect\phantomsection\label{threefold-vision-of-beulah-the-affective-and-psychological-threshold}
...
\begin{block}{Fourfold Vision of Eden: The Ultimate Prophetic Monetary
Assertion}
\protect\phantomsection\label{fourfold-vision-of-eden-the-ultimate-prophetic-monetary-assertion}
