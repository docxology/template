...
\begin{frame}{Introduction: Gold, Silver, and the Architecture of Value}
\protect\phantomsection\label{introduction-gold-silver-and-the-architecture-of-value}
...
overvalued metal remains {[}@thornton1802nature{]}. The eponymous
...
@quinn2007recoinage{]}. The physical disappearance of metallic currency
set the necessary preconditions for the rise of abstract financial
instruments.
...
{[}@schouten2021lucretius{]}. While the Bank of England increasingly
...
(quoted under \hyperlink{sec-illuminated-nonduality}{§ Illuminated
Nonduality}) {[}@erdman1988complete{]}. For Blake, emergent capitalism
...
a mythopoetic articulation of this struggle, a historically consistent
...
{[}@mee2003politics; @green2007sublime{]}.
\end{block}

\begin{block}{Manuscript Structure and Methodology for the Blakean
Monetary Arc}
\protect\phantomsection\label{manuscript-structure-and-methodology-for-the-blakean-monetary-arc}
