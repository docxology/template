...
{[}@erdman1954prophet{]}. Erdman further reports that Blake warned Paine
during the government's pursuit of him for seditious libel after
...
indeterminate situation {[}@friedman2026blake; @friedman2026doors{]}.
...
Britain {[}@sylla2018hamiltons{]}. The silver dollar was defined at
...
Latin American mines {[}@redish2000bimetallism{]}. Consequently,
...
resolve {[}@friedman2026blake{]}. The Preludium to \emph{America}
...
{[}@erdman1988complete{]}. When we read this mythological unchaining
...
riches}) {[}@erdman1988complete; @sklar2011blake{]}: both Blake and
...
than either political faction could articulate {[}@makdisi2003william;
@makdisi2014reading{]}.
...
{[}@blake1789thel{]}---see \hyperlink{sec-urizenic-materialism}{§
...
into what Blake names ``Newton's Sleep'' {[}@friedman2026blake;
@friedman2026doors{]}. The Hamilton-Jefferson antinomy is, in this
reading, a \emph{bifurcation} of the American political mind: reason
(Hamilton) sundered from embodied agricultural sensation (Jefferson),
with neither capable of the integrative Fourfold Vision that Blake
demanded.
\end{block}
\end{frame}
