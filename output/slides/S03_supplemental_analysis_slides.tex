...
\begin{block}{S3.1.1 Non-Convex Optimization Extensions}
\protect\phantomsection\label{s3.1.1-non-convex-optimization-extensions}
...
\begin{block}{S3.1.2 Stochastic Variants and Convergence Guarantees}
\protect\phantomsection\label{s3.1.2-stochastic-variants-and-convergence-guarantees}
...
\begin{block}{S3.2 Computational Complexity Analysis}
\protect\phantomsection\label{s3.2-computational-complexity-analysis}
\begin{block}{S3.2.1 Per-Iteration Cost Breakdown}
\protect\phantomsection\label{s3.2.1-per-iteration-cost-breakdown}
...
\begin{block}{S3.2.2 Memory Complexity Analysis}
\protect\phantomsection\label{s3.2.2-memory-complexity-analysis}
...
\begin{block}{S3.3 Convergence Rate Analysis}
\protect\phantomsection\label{s3.3-convergence-rate-analysis}
\begin{block}{S3.3.1 Rate of Convergence for Different Problem Classes}
\protect\phantomsection\label{s3.3.1-rate-of-convergence-for-different-problem-classes}
\begin{table}[h]
\centering
...
\begin{block}{S3.3.2 Comparison with Existing Methods}
\protect\phantomsection\label{s3.3.2-comparison-with-existing-methods}
...
\begin{block}{S3.4 Sensitivity and Robustness Analysis}
\protect\phantomsection\label{s3.4-sensitivity-and-robustness-analysis}
\begin{block}{S3.4.1 Hyperparameter Sensitivity}
\protect\phantomsection\label{s3.4.1-hyperparameter-sensitivity}
...
\begin{block}{S3.4.2 Numerical Stability Analysis}
\protect\phantomsection\label{s3.4.2-numerical-stability-analysis}
...
\begin{block}{S3.5 Extended Experimental Validation}
\protect\phantomsection\label{s3.5-extended-experimental-validation}
\begin{block}{S3.5.1 Additional Benchmark Problems}
\protect\phantomsection\label{s3.5.1-additional-benchmark-problems}
...
\begin{block}{S3.5.2 Statistical Significance Testing}
\protect\phantomsection\label{s3.5.2-statistical-significance-testing}
...
\begin{block}{S3.6 Implementation Optimizations}
\protect\phantomsection\label{s3.6-implementation-optimizations}
\begin{block}{S3.6.1 Vectorization and Parallelization}
\protect\phantomsection\label{s3.6.1-vectorization-and-parallelization}
...
\begin{block}{S3.6.2 Code Quality and Reproducibility}
\protect\phantomsection\label{s3.6.2-code-quality-and-reproducibility}
...
\begin{block}{S3.7 Limitations and Future Directions}
\protect\phantomsection\label{s3.7-limitations-and-future-directions}
\begin{block}{S3.7.1 Current Limitations}
\protect\phantomsection\label{s3.7.1-current-limitations}
...
\begin{block}{S3.7.2 Future Research Directions}
\protect\phantomsection\label{s3.7.2-future-research-directions}
