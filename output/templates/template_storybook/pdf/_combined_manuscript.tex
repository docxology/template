...
\makeatother
\hypersetup{
  pdftitle={The Shape Between: A Full-Page Illustrated Storybook Template},
...
\item
  \breaktt{src/storybook/text\_layout.py} owns deterministic typography,
  wrapping, and text overlays.
\item
