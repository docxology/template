...
\breaktt{2026-07-12T22:24:06Z}) into sec.~\ref{sec:reproducibility}.
...
\href{https://github.com/docxology/template/blob/main/projects/templates/template_methods_paper/scripts/methods_analysis.py}{methods
analysis orchestrator} (\breaktt{scripts/methods\_analysis.py}), which
calls \texttt{run\_all\_gates} and \texttt{compile\_method} from
...
\breaktt{2026-07-12T22:24:06Z} records when the variables were generated
