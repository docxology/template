...
| Figure | `projects/special_number_proximity/output/figures/proximity_histogram.png` |
...
- Figures: `![caption](../output/figures/proximity_histogram.png){#fig:label}` then `\ref{fig:label}` in prose.
