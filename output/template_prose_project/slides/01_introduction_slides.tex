...
(\breakseq{[@sec:results]}), and the architectural lessons drawn from doing the
prose work alongside the code and literature exemplars in the same
template (\breakseq{[@sec:conclusion]}).
\end{frame}
