...
- A detailed specification of the ten-stage DAG-based build pipeline (Stages 00–07), from environment sanitization through executive report generation.
...
- An empirical evaluation of the system across three heterogeneous exemplar projects (`code_project`, `cognitive_case_diagrams`, `template`), demonstrating scalability, coverage metrics, and pipeline timing.
...
| `cognitive_case_diagrams` | Active | Compositional case modeling | ${project_cognitive_case_diagrams_src_module_count} modules | 890 | 90%+ | ~60 |
