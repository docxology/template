...
\begin{block}{\texttt{infrastructure.core} (28 modules)}
\protect\phantomsection\label{infrastructure.core-28-modules}
...
\begin{block}{\texttt{infrastructure.llm} (30 modules)}
\protect\phantomsection\label{infrastructure.llm-30-modules}
...
\begin{block}{\texttt{infrastructure.project} (2 modules)}
\protect\phantomsection\label{infrastructure.project-2-modules}
...
\begin{block}{\texttt{infrastructure.publishing} (9 modules)}
\protect\phantomsection\label{infrastructure.publishing-9-modules}
...
\begin{block}{\texttt{infrastructure.rendering} (12 modules)}
\protect\phantomsection\label{infrastructure.rendering-12-modules}
...
\begin{block}{\texttt{infrastructure.reporting} (14 modules)}
\protect\phantomsection\label{infrastructure.reporting-14-modules}
...
\begin{block}{\texttt{infrastructure.steganography} (8 modules)}
\protect\phantomsection\label{infrastructure.steganography-8-modules}
...
\begin{block}{\texttt{infrastructure.validation} (22 modules)}
\protect\phantomsection\label{infrastructure.validation-22-modules}
...
Duality} and \hyperlink{the-ai-collaboration-model}{AI Collaboration}
...
defined by Garijo et al.'s FAIRsoft evaluator {[}@garijo2024fairsoft{]}.
\end{block}
\end{frame}
