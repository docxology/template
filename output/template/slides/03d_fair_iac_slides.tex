...
\begin{frame}[fragile]{FAIR Alignment and Research Infrastructure as
Code}
...
{[}@garijo2024fairsoft{]}. The pipeline's automated testing and coverage
...
independently reproducible {[}@wilson2017good{]}. \texttt{template/}
...
Software Heritage {[}@cosmo2020softwareheritage{]} provides persistent
...
DOI for publication metadata {[}@katz2021software{]}.
\end{block}
\end{frame}
