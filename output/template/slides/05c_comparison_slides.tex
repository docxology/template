...
bifurcates: workflow managers (Snakemake {[}@koster2012snakemake{]},
Nextflow {[}@ditommaso2017nextflow{]}, CWL {[}@amstutz2016cwl{]})
provide distributed execution but no manuscript support; publication
tools (Quarto {[}@allaire2024quarto{]}, Jupyter Book, R Markdown
