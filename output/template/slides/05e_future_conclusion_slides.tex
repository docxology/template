...
that tests \hyperlink{the-zero-mock-tradeoff}{reflect reality}. The
steganographic provenance layer ensures that published artifacts carry
their own \hyperlink{security-and-provenance}{authentication}. The
\hyperlink{appendix-matrix}{comparative analysis} confirms that no
