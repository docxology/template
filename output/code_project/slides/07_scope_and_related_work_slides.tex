...
\begin{frame}[fragile]{Scope, Related Work, and Positioning}
\protect\phantomsection\label{scope-related-work-and-positioning}
...
\begin{block}{Classical gradient methods}
...
\begin{block}{Adaptive and stochastic extensions}
...
\begin{block}{What this project proves about the template}
...
\begin{block}{Explicit limitations}
