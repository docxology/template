...
\begin{frame}[fragile]{Manuscript Syntax Reference}
\protect\phantomsection\label{manuscript-syntax-reference}
Formatting and syntax conventions for manuscript Markdown files in the
\texttt{code\_project} exemplar.

\begin{block}{Citation Syntax (Pandoc)}
...
\begin{block}{Equation Environments}
...
\begin{block}{Preamble Injection}
...
\begin{block}{BibTeX Entry Format}
