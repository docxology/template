...
- **Reporting & Integrity**: `infrastructure.reporting` (pipeline summaries and reports) and `infrastructure.validation.output.validator` assuring CSV/JSON configurations conform.
...
- **Generated**: 2026-04-08T12:42:04Z
