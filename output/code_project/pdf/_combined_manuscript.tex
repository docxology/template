...
\item
  ...
  suite exercises \texttt{infrastructure} modules (for example
  \texttt{infrastructure.reporting.pipeline\_io},
  \texttt{infrastructure.validation}) so reporting and validation paths
  stay deterministic.
\item
...
\item
  \textbf{Reporting \& Integrity}: \texttt{infrastructure.reporting}
  (pipeline summaries and reports) and
...
\item
  \textbf{Generated}: 2026-04-08T12:42:04Z
\end{itemize}
