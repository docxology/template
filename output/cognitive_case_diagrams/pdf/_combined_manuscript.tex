...
\citep{coecke2010mathematical, grefenstette2015concrete, sadrzadeh2013compositional}
maps pregroup derivations functorially into vector spaces, enabling
empirical evaluation. Recent extensions include DisCoCirc
\citep{defelice2020discourse, defelice2022discocirc} for discourse-level
coherence and the lambeq library \citep{lorenz2023lambeq} for quantum
...
Fritz et al.'s \citeyearpar{fritz2021enriched} enrichment over \([0,1]\)
...
formalism. \autoref{fig:discourse} illustrates a multi-sentence
...
framework of Fritz et al. \citeyearpar{fritz2021enriched} provides the
key construction.
...
Fritz et al. \citeyearpar{fritz2021enriched} interpret hom-values as
...
\subsection{Enriched Functors and Bradley's Language-as-Category
Model}\label{enriched-functors-and-bradleys-language-as-category-model}
...
\subsubsection{C3: Case-Marked DisCoCat, Compact Closure, and Discourse
Extension}\label{c3-case-marked-discocat-compact-closure-and-discourse-extension}
...
Through Fritz et al.'s \citeyearpar{fritz2021enriched} enrichment
