...
\begin{block}{Prompt Injection as Adversarial Case-Frame Manipulation}
...
\begin{block}{Case-Theoretic Firewalls for Multi-Agent Communication}
...
\begin{block}{Epistemic Case Security in Multi-Agent Systems}
