...
300\,dpi exports) are centralized in \texttt{src/figures.py} and
...
\item
  ...
  references a generator in \texttt{src/figures.py} (orchestrated via
...
\item
  \textbf{Project tests}:
  \href{../tests/test_optimizer.py}{\breaktt{projects/template\_code\_project/tests/test\_optimizer.py}}
  exercises \texttt{src/optimizer.py} (typical, edge, boundary, and
  ...
  size:
  \href{../../../docs/_generated/canonical_facts.md}{\breaktt{docs/\_generated/canonical\_facts.md}}.
\item
...
\texttt{src/figures.py} (\breaktt{generate\_convergence\_plot},
...
\texttt{src/analysis.py} / \breaktt{scripts/optimization\_analysis.py}.
...
\item
  \textbf{Generated}: 2026-05-24T18:26:58Z
\end{itemize}
...
Analysis reports & 8 \\
\textbf{Total artifacts} & \textbf{18} \\
\end{longtable}
}
