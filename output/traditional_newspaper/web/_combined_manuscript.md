...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_02_national.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_03_world.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_04_business.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_05_technology.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_06_sports.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_07_arts.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_08_editorial.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_10_letters.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_11_local.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_13_health.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_14_science.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_15_obituaries.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\linewidth]{../output/figures/section_banner_16_classifieds.png}
\caption{Monochrome desk banner for this folio; raster from \texttt{generate\_section\_banners.py}.}
