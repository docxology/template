...
\author{Daniel Ari Friedman\\Active Inference Institute\\\texttt{daniel@activeinference.institute}\\\href{https://orcid.org/0000-0001-6232-9096}{ORCID: 0000-0001-6232-9096}\\[1em]\href{https://doi.org/10.5281/zenodo.18364119}{DOI: 10.5281/zenodo.18364119}}
\date{2026-01-24}
...
Adversarial Content
(Moltbot)}{Scenario \textbackslash Omega\_2\textquotesingle: Browser-Fetched Adversarial Content (Moltbot)}}\label{scenario-omega_2-browser-fetched-adversarial-content-moltbot}
...
\subsection{Theorem 3.1: Trust Boundedness}\label{sec:thm31-proof}
...
\subsection{Theorem 6.1: Belief Injection
Resistance}\label{sec:thm61-proof}
...
\subsection{Theorem 6.2: No Trust Amplification}\label{sec:thm62-proof}
...
\subsection{Theorem 6.3: Goal Alignment
Invariant}\label{sec:thm63-proof}
...
\subsection{Theorem 6.4: Firewall Liveness}\label{sec:thm64-proof}
...
\subsection{Theorem 6.5: Byzantine Consensus
Termination}\label{sec:thm65-proof}
...
\subsection{Theorem 6.6: Bounded Overhead}\label{sec:thm66-proof}
