...
1. Add the generator function to `scripts/optimization_analysis.py` following the existing pattern (write PNG to `projects/template_code_project/output/figures/`).
