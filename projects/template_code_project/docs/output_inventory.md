...
|------|------|--------------|----------------|
| `output/figures/convergence_plot.png` | Gradient descent trajectories | `generate_convergence_plot()` in `scripts/optimization_analysis.py` | 4 — Run Analysis |
| `output/figures/step_size_sensitivity.png` | Step-size vs final objective | `generate_step_size_sensitivity_plot()` | 4 — Run Analysis |
| `output/figures/convergence_rate_comparison.png` | Convergence-rate comparison across α | `generate_convergence_rate_plot()` | 4 — Run Analysis |
| `output/figures/algorithm_complexity.png` | O(·) complexity visual | `generate_complexity_visualization()` | 4 — Run Analysis |
| `output/figures/performance_benchmark.png` | Benchmark dims vs time | `generate_benchmark_visualization()` | 4 — Run Analysis |
| `output/figures/stability_analysis.png` | Stability heat map | `generate_stability_visualization()` | 4 — Run Analysis |
...
| `output/reports/analysis_dashboard.html` | HTML dashboard | `generate_analysis_dashboard()` in `src/dashboard.py` | 4 — Run Analysis |
...
1. Add the generator in the appropriate module:
   - **Figures** → `src/analysis.py` or `src/dashboard.py` (call from `scripts/optimization_analysis.py`)
...
- [`../docs/output_conventions.md`](../docs/output_conventions.md) — layout, regeneration policy, troubleshooting
- [`../docs/rendering_pipeline.md`](../docs/rendering_pipeline.md) — 4-phase manuscript → PDF flow
