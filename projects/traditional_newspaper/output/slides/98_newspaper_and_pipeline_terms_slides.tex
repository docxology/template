...
raster asset \texttt{output/figures/masthead.png}, floated and captioned
in the combined PDF (\texttt{fig:masthead}). \\
...
\begin{block}{Narrative: how the terms fit together}
\protect\phantomsection\label{narrative-how-the-terms-fit-together}
...
\begin{block}{Using this glossary in reviews}
\protect\phantomsection\label{using-this-glossary-in-reviews}
...
\begin{block}{Future-facing notes}
\protect\phantomsection\label{future-facing-notes}
