...
```mermaid
graph TD
    A[test_optimizer.py — 34 tests] --> B[TestQuadraticFunction]
...
> **Zero-Mock Policy**: All 34 tests use real `OptimizationResult` instances and real computations. No `unittest.mock`, `MagicMock`, `@patch`, or synthetic `type()` objects.
