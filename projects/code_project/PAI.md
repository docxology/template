...
- **Consult the Docs Hub FIRST**: Before executing commands, read `projects/code_project/docs/agent_instructions.md` and related structural guides.
- **Thin Orchestrator**: Scripts import from `src/`, never implement core programmatic logic.
- **Test Coverage**: 90%+ required for all `src/` modules (this exemplar strictly enforces 100% via `pyproject.toml`).
- **Zero-Mock Policy**: See `docs/testing_philosophy.md` for strict boundaries on testing.
