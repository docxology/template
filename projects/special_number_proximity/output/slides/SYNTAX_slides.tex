...
\begin{frame}[fragile]{Manuscript syntax}
\protect\phantomsection\label{manuscript-syntax}
\begin{itemize}
\tightlist
\item
...
\item
  Figures:
  e.g.~\texttt{!{[}caption{]}(../output/figures/proximity\_histogram.png)\{\#fig:label\}}
  or \texttt{proximity\_histogram\_pooled.png}; then
  \texttt{\textbackslash{}ref\{fig:label\}} in prose.
\end{itemize}
