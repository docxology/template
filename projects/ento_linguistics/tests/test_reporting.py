...
class TestReportingModuleFunctions:
    ...
    def test_stub_error_aggregator_add_and_summary(self):
        """Test _StubErrorAggregator.add_error and get_summary directly."""
        from pipeline.reporting import _StubErrorAggregator

        agg = _StubErrorAggregator()
    ...
    def test_get_error_aggregator_returns_instance(self):
        ...
        # ErrorAggregator.add_error requires error_type and message; _StubErrorAggregator accepts **kwargs
        try:
            agg.add_error(error_type="test", message="test msg")
        except TypeError:
            # Fallback for _StubErrorAggregator which accepts **kwargs
