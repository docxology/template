...
End-to-end testing for the research pipeline, ensuring all components work together correctly from data generation through final manuscript production.

## Overview

Integration tests validate the **research workflow** using data and computations. These tests ensure that:
...
|-----------|---------|-----------------|
| `test_integration_pipeline.py` | pipeline | Data → Figures → Manuscript → Validation |
