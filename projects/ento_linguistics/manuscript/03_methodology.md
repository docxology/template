...
### Rhetorical and Persuasive Analysis

To bridge quantitative text mining and qualitative discourse analysis, the pipeline implements automated rhetorical and persuasive technique detection. The rhetorical analysis module quantifies the frequency and structural impact of authority citations, analogies, generalizations, and anecdotal evidence. It maps these strategies onto broader narrative frameworks—such as progress, conflict, discovery, and complexity narratives—to evaluate how findings are contextualized across the literature.

Concurrently, the persuasive analysis module evaluates the utilization of rhetorical questions, metaphorical language, and normative assertions. It tracks context-dependent usage and conceptual shifts across time periods, assigning effectiveness scores based on frequency and context diversity. Furthermore, it quantifies the impact of underlying framing effects (e.g., anthropomorphic, mechanistic, teleological) by correlating framing indicators with downstream argumentative structures.
