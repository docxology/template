...
**Comprehensive guide for using template infrastructure modules:**
...
def research_workflow_with_quality_assurance():
    """Complete research workflow with quality checks."""
...
- Update infrastructure usage examples with new features
...
- Require AGENTS.md updates for new modules
...
- All new modules require AGENTS.md documentation
...
**Review Checklist:**
- [ ] AGENTS.md exists for new modules
...
2. **Create Content**: Write comprehensive documentation following standards
