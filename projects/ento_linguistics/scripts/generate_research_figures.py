...
# Import infrastructure validation modules (optional - for enhanced functionality)
try:
    from infrastructure.validation import validate_figure_registry, verify_output_integrity
    INFRASTRUCTURE_AVAILABLE = True
except ImportError:
    # Infrastructure not available - run in standalone mode
...
def main() -> None:
    ...
    if INFRASTRUCTURE_AVAILABLE and validate_figure_registry:
        ...
        logger.info("ℹ️  Infrastructure not available - skipping figure registry validation")
