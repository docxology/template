...
def run_analysis_pipeline(texts: List[str]) -> Dict[str, Any]:
    ...
    # Pre-compute actual extracted term counts per domain from the terms dict
    ...
    # Semantic entropy H(t) per domain from S02 supplemental table (bits)
    # These are the mean H values from the semantic entropy distribution analysis
    semantic_entropy_map = {
        "unit_of_individuality": 1.72,
        "behavior_and_identity": 1.54,
        "power_and_labor": 1.91,
        "sex_and_reproduction": 1.28,
        "kin_and_relatedness": 1.78,
        "economics": 1.15,
    }
