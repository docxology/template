...
def main() -> None:
    ...
    Example:
        $ python literature_analysis_pipeline.py --max-publications 1000 --verbose
        $ python literature_analysis_pipeline.py --no-cache --output-dir /custom/path
    """
    import argparse
    ...
    logger.info(f"Pipeline execution time: {results['pipeline_metadata']['total_duration']:.1f}s")
