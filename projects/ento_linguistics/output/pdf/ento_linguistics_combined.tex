...
Analysis of a corpus of \textbf{354 entomological publications} (46,673
tokens; 6,921 unique token types) extracts \textbf{847 candidate terms}
(219 assigned to specific domains) across six Ento-Linguistic domains,
...
all 219 domain-assigned terms, 73.4\% exhibit context-dependent
...
component processes a \textbf{corpus of 354 entomological publications}
(46,673 tokens; 6,921 unique token types; 847 extracted candidate terms,
219 domain-assigned) using automated term extraction, co-occurrence
...
\endlastfoot
Documents & \textbf{354} \\
Total processed tokens & \textbf{46,673} \\
Unique token types & \textbf{6,921} \\
Candidate terms extracted & \textbf{847} \\
Domain-assigned terms & \textbf{219} \\
\end{longtable}
}
...
(\texttt{WordNetLemmatizer}) --- is documented in
\texttt{src/data/data\_processing.py::preprocess\_corpus}.
...
Domain-specific extraction from \textbf{354 publications} (46,673
tokens) identified \textbf{847 candidate terms} total, of which
\textbf{219 receive domain assignments} spanning all six domains, with
...
of terminology networks across \textbf{354 entomological publications}
(46,673 tokens; 847 extracted candidate terms, 219 domain-assigned) and
...
\(D_j\) & Eq. \ref{eq:cross_domain_mapping} \\
