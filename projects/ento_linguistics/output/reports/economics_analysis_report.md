...
**Analysis Date:** 2025-12-30T15:52:42.145643
**Domain:** economics
**Terms Analyzed:** 4
...
### Most Frequent Terms
- **cost-effective**: 5 occurrences
- **trade-off**: 3 occurrences
- **out-of-distribution**: 2 occurrences
- **trade-offs**: 2 occurrences

### Term Patterns
- compound: 4 instances
...
#### cost-effective\n- **Frequency**: 5\n- **Contexts**: 5\n- **Domains**: economics\n- **Sample Usage**: deep learning techniques **cost-effective** lensless digital holographic\n
...
#### trade-offs\n- **Frequency**: 2\n- **Contexts**: 2\n- **Domains**: economics\n- **Sample Usage**: multidimensional performance **trade-offs** bipedal standing common\n
