...
**Analysis Date:** 2025-12-30T15:52:40.131802
...
- **behavioral**: 11 occurrences
- **behaviors**: 5 occurrences
- **foraging**: 5 occurrences
...
#### behavioral\n- **Frequency**: 11\n- **Contexts**: 5\n- **Domains**: behavior_and_identity\n- **Sample Usage**: assessment **behavioral** clinical histological outcomes\n
#### behaviors\n- **Frequency**: 5\n- **Contexts**: 5\n- **Domains**: behavior_and_identity\n- **Sample Usage**: package classifying ungulate **behaviors** three states smiley\n
#### foraging\n- **Frequency**: 5\n- **Contexts**: 5\n- **Domains**: behavior_and_identity\n- **Sample Usage**: underground nests **foraging** activity invasive conehead\n
