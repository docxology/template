...
- **Sample Terms**: colony, superorganism, individual, holobiont, organism
...
- **Sample Terms**: foraging, caste, behavioral, behaviors, specialization

#### reproductive_biology
- **Description**: Reproductive systems and sex determination
- **Associated Terms**: 5 terms
- **Domains**: sex_and_reproduction
- **Sample Terms**: reproduction, sex determination, mating, parthenogenesis, haplodiploidy

#### kinship_systems
- **Description**: Genetic and social relatedness structures
- **Associated Terms**: 5 terms
- **Domains**: kin_and_relatedness
- **Sample Terms**: relatedness, decision-making, altruism, inclusive fitness, kin selection

#### resource_economics
- **Description**: Resource allocation and economic principles
- **Associated Terms**: 6 terms
- **Domains**: economics
- **Sample Terms**: trade-off, cost-benefit, resource allocation, cost-effective, trade
...
- **Sample Terms**: foraging, trade-off, adaptation, fitness, optimization
...
- **coarse-grained**: Connected to 0 concepts ()
- **birth-death**: Connected to 0 concepts ()
- **self-supervised**: Connected to 0 concepts ()
- **real-world**: Connected to 0 concepts ()
- **single-cell**: Connected to 0 concepts ()
- **agent-based**: Connected to 0 concepts ()
- **dual-path**: Connected to 0 concepts ()
