...
# Ensure infrastructure/ is on path BEFORE imports
...
def main() -> None:
    ...
    if args.json:
        ...
        print(f"Manuscript dir: {args.manuscript_dir}")
        ...
        if result.missing_glossary_markers:
            print("❌ Glossary markers missing in 98_symbols_glossary.md")
        else:
            print("✅ Glossary markers present")

        if result.missing_references_block:
            print("❌ References block missing in 99_references.md")
        else:
            print("✅ References block present")
