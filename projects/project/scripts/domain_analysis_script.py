...
"""
    ...
    def _generate_domain_figures(self, domain_name: str, analysis: DomainAnalysis,
        ...
        if domain_terms:
            ...
            plt.tight_layout()
            freq_file = self.figures_dir / f"{domain_name}_term_frequencies.png"
        ...
        if analysis.ambiguities:
            ...
            plt.tight_layout()
            amb_file = self.figures_dir / f"{domain_name}_ambiguities.png"
...
def main():
    ...
    if args.domain == 'all':
        ...
        print(f"Analyzed {results['summary']['domains_analyzed']} domains")
        print(f"Total terms: {results['summary']['total_terms']}")
        print(f"Comparative report: {results['comparative_report']}")
    else:
        ...
        if results:
            print(f"Analysis completed for {args.domain}")
            print(f"Terms analyzed: {results.get('terms_analyzed', 0)}")
            ...
            print(f"Analysis failed for {args.domain}")
