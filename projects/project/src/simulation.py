"""Core simulation framework for scientific computing.

This module provides a robust simulation engine with reproducibility,
checkpointing, and result serialization capabilities.
"""
    ...
    def load_checkpoint(self, iteration: int) -> bool:
        ...
        try:
            ...
            if self.state.iteration > 0:
                self.start_time = time.time()  # Approximate, checkpoint doesn't store this
