...
class TestDomainAnalyzer:
    ...
    def test_analyze_all_domains(self, analyzer: DomainAnalyzer,
        ...
        analyses = analyzer.analyze_all_domains(list(sample_terms.items()), sample_texts)
    ...
    def test_group_terms_by_domain(self, analyzer: DomainAnalyzer,
        ...
        domain_groups = analyzer._group_terms_by_domain(list(sample_terms.items()))
...
class TestDomainAnalysisIntegration:
    ...
    def test_complete_domain_workflow(self) -> None:
        ...
        # Each analysis should have required components
    ...
    def test_cross_domain_term_handling(self) -> None:
        ...
        # Check that recommendations address complexity
        for analysis in analyses.values():
            assert len(analysis.recommendations) > 0
    ...
    def test_recommendation_quality(self) -> None:
        ...
        for domain_name, analysis_func in domains_to_test:
            ...
            # Recommendations should be specific to the domain
            for recommendation in analysis.recommendations:
                assert len(recommendation) > 10  # Should be detailed
                assert any(keyword in recommendation.lower()
                          for keyword in domain_name.split('_'))  # Should reference domain concepts