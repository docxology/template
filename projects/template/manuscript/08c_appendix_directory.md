...
```text
template/
├── infrastructure/           # Layer 1: Shared services (~${total_infra_python_files} .py files)
...
├── tests/                    # Infrastructure test suite (${infra_test_file_count}+ files, ~${infra_test_count_approx} tests)
├── docs/                     # Repository documentation (${docs_file_count}+ files, ${docs_subdir_count} subdirectories)
