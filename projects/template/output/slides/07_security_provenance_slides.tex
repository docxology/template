...
pioneered by Cox et al. {[}@cox1997secure{]} for multimedia integrity
...
of Materials (SBOM) {[}@ntia2021sbom{]} further standardize the
...
Software Heritage {[}@cosmo2020softwareheritage{]} complements this
...
{[}@katz2021software{]} software citation principles' requirement that
