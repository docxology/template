...
\item
  ...
  test doubles. \textasciitilde6,021 infrastructure tests and 1258+
...
test suite alone contains \textasciitilde6,021 tests across 346+ test
files.
...
\tightlist
\item
  \textbf{Infrastructure tests} (\texttt{tests/}): \textasciitilde6,021
...
\item
  ...
  (\texttt{code\_project}) to 912 tests
...
\texttt{cognitive\_case\_diagrams} & 7 & \textasciitilde60s & 912/912 &
90\%+ \\
...
The \texttt{cognitive\_case\_diagrams} project, with its 912 tests and
...
\endlastfoot
Test files & 346+ \\
Total tests & \textasciitilde6,021 \\
...
\item
  ...
  to linguistic case for cognitive modeling, 912 tests, 90\%+ coverage,
...
comprises \textasciitilde271 Python modules validated by 6,021 tests.
...
\NormalTok{├── tests/                    \# Infrastructure test suite (346+ files, \textasciitilde{}6,021 tests)}
