...
separates 13 reusable infrastructure subpackages (\textasciitilde276
Python modules, validated by \textasciitilde6,036 tests) from
...
922 tests), and this self-referential architectural analysis
...
\item
  ...
  \textasciitilde276 Python modules provide reusable services; projects
...
\item
  ...
  test doubles. \textasciitilde6,036 infrastructure tests and 1271+
...
subpackages comprising \textasciitilde276 modules and providing reusable
...
test suite alone contains \textasciitilde6,036 tests across 347+ test
files.
...
\tightlist
\item
  \textbf{Infrastructure tests} (\texttt{tests/}): \textasciitilde6,036
...
\item
  ...
  (\texttt{code\_project}) to 922 tests
...
\texttt{cognitive\_case\_diagrams} & 7 & \textasciitilde60s & 922/922 &
90\%+ \\
...
The \texttt{cognitive\_case\_diagrams} project, with its 922 tests and
...
\endlastfoot
Test files & 347+ \\
Total tests & \textasciitilde6,036 \\
...
\texttt{core} & 72 & ✓ & ✓ & \texttt{get\_logger},
...
reports \\
\texttt{reporting} & 44 & ✓ & ✓ & Coverage parsing, executive reports \\
...
hashing \\
\texttt{validation} & 35 & ✓ & ✓ & PDF validation, Markdown checking,
CLI \\
\end{longtable}
}
...
duration: the full infrastructure test suite (\textasciitilde6,036
...
\item
  ...
  to linguistic case for cognitive modeling, 922 tests, 90\%+ coverage,
...
infrastructure layer---13 modules, \textasciitilde276 Python
...
\toprule\noalign{}
Metric & \texttt{code\_project} & \texttt{cognitive\_case\_diagrams} &
\texttt{template} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
comprises \textasciitilde276 Python modules validated by 6,036 tests.
...
\subsection{\texorpdfstring{\texttt{infrastructure.core} (72
modules)}{infrastructure.core (72 modules)}}\label{infrastructure.core-72-modules}
...
\subsection{\texorpdfstring{\texttt{infrastructure.reporting} (44
modules)}{infrastructure.reporting (44 modules)}}\label{infrastructure.reporting-44-modules}
...
\subsection{\texorpdfstring{\texttt{infrastructure.validation} (35
modules)}{infrastructure.validation (35 modules)}}\label{infrastructure.validation-35-modules}
...
module-dense package (35 files), reflecting the breadth of integrity
...
\begin{Highlighting}[]
\NormalTok{template/}
\NormalTok{├── infrastructure/           \# Layer 1: Shared services (\textasciitilde{}276 .py files)}
...
\NormalTok{├── tests/                    \# Infrastructure test suite (347+ files, \textasciitilde{}6,036 tests)}
...
modeling & 39 modules & 922 & 90\%+ & \textasciitilde60 \\
