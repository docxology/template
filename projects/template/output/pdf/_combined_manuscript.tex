...
Python modules, validated by \textasciitilde6,026 tests) from
...
814 tests), and this self-referential architectural analysis
...
\item
  ...
  \textasciitilde271 Python modules provide reusable services; projects
...
\item
  ...
  test doubles. \textasciitilde6,026 infrastructure tests and 919+
...
subpackages comprising \textasciitilde271 modules and providing reusable
...
test suite alone contains \textasciitilde6,026 tests across 346+ test
files.
...
\tightlist
\item
  \textbf{Infrastructure tests} (\texttt{tests/}): \textasciitilde6,026
...
\item
  ...
  (\texttt{code\_project}) to 814 tests
...
\texttt{cognitive\_case\_diagrams} & 7 & \textasciitilde60s & 814/814 &
90\%+ \\
...
The \texttt{cognitive\_case\_diagrams} project, with its 814 tests and
...
\endlastfoot
Test files & 346+ \\
Total tests & \textasciitilde6,026 \\
...
reports \\
\texttt{reporting} & 40 & ✓ & ✓ & Coverage parsing, executive reports \\
...
source-code access. The aggregate documentation footprint (160+ files)
...
duration: the full infrastructure test suite (\textasciitilde6,026
...
\item
  ...
  to linguistic case for cognitive modeling, 814 tests, 90\%+ coverage,
...
infrastructure layer---13 modules, \textasciitilde271 Python
...
comprises \textasciitilde271 Python modules validated by 6,026 tests.
...
\subsection{\texorpdfstring{\texttt{infrastructure.reporting} (40
modules)}{infrastructure.reporting (40 modules)}}\label{infrastructure.reporting-40-modules}
...
\begin{Highlighting}[]
\NormalTok{template/}
\NormalTok{├── infrastructure/           \# Layer 1: Shared services (\textasciitilde{}271 .py files)}
...
\NormalTok{├── tests/                    \# Infrastructure test suite (346+ files, \textasciitilde{}6,026 tests)}
\NormalTok{├── docs/                     \# Repository documentation (160+ files, 15 subdirectories)}
...
modeling & 39 modules & 814 & 90\%+ & \textasciitilde60 \\
