...
from manuscript.sheaf.models import ManifestIssue, SheafSection, TrackRegistry, TrackSpec
...
def _resolve_section_figures(
    ...
    body = render_section_figures(project_root, section.id)
    if body:
        return body
...
def _resolve_layers_report(
    ...
    from manuscript.sheaf.layers_report import render_sheaf_layers_markdown
