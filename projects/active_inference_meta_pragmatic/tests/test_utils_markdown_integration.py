...
class TestMarkdownIntegration:
    ...
    def test_initialization_with_path_string(self, tmp_path):
        ...
        assert integration.manuscript_dir == manuscript_dir or str(integration.manuscript_dir) == str(manuscript_dir)
    ...
    def test_multiple_operations(self, tmp_path):
        ...
        result3 = integration.insert_figure_in_section(markdown_file, "fig:1", "Section 1")
        result4 = integration.insert_figure_in_section(markdown_file, "fig:2", "Section 1")
