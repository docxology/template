...
class TestEdgeCases:
    ...
    def test_policy_out_of_range(self):
        ...
        assert "range" in str(exc_info.value).lower() or "actions" in str(exc_info.value).lower()
    ...
    def test_A_matrix_wrong_dimensions(self):
        ...
        assert "2-dimensional" in str(exc_info.value) or "dimension" in str(exc_info.value).lower()
