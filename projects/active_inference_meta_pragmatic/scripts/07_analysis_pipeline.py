...
def execute_visualization_generation(
    ...
    try:
        ...
        # Register with figure manager
        figure_manager.register_figure(
            filename="active_inference_concepts.png",
            caption="Core Active Inference concepts showing generative model structure",
        ...
        # Register with figure manager
        figure_manager.register_figure(
            filename="meta_cognition_diagram.png",
            caption="Meta-cognitive processing architecture showing hierarchical relationship between cognitive and meta-cognitive levels",
