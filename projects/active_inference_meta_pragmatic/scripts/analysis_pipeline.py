...
def main() -> None:
    ...
    try:
        ...
        if not args.dry_run:
            ...
            generate_final_report(pipeline_results, perf_monitor, reports_dir, start_time)
...
def execute_validation_verification(pipeline_results: Dict, error_aggregator) -> Dict:
    ...
    try:
        ...
        validation_results['figures'] = {"status": "not_validated", "reason": "infrastructure not available"}
    except Exception as e:
...
def generate_final_report(pipeline_results: Dict, perf_monitor, reports_dir: Path, start_time: float) -> None:
