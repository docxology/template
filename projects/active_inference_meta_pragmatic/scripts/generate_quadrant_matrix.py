...
def create_enhanced_quadrant_diagram(viz_engine: VisualizationEngine,
                                   quadrant_framework: QuadrantFramework,
    ...
    colors = ['#E8F4FD', '#FFF3E0', '#F3E5F5', '#E8F5E8']  # Light colors for each quadrant
    ...
    for i, (quadrant_id, (row, col)) in enumerate(zip(quadrant_names, positions)):
        ...
        ax.add_patch(plt.Rectangle((0, 0), 1, 1, transform=ax.transAxes,
                                 facecolor=colors[i], alpha=0.3, zorder=-1))
