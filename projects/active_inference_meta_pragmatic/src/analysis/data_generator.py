...
class DataGenerator:
    ...
    def generate_categorical_observations(
        ...
        try:
            ...
            logger.debug(
                f"Generated categorical observations: {n_samples} samples, {n_categories} categories"  # noqa: E501
            )
            return observations
    ...
    def generate_synthetic_dataset(
        ...
        try:
            ...
            logger.debug(
                f"Created synthetic dataset: {n_samples} samples, {n_features} features, {n_classes} classes"  # noqa: E501
            )
