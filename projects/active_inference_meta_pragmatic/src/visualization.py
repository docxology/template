...
class VisualizationEngine:
    ...
    def save_figure(self, fig: plt.Figure, filename: str) -> Dict[str, Union[str, Path]]:
        ...
        try:
            ...
            logger.info(f"Saved figure: {filename} (PNG and PDF)")
            return saved_files
    ...
    def create_quadrant_matrix_plot(self, matrix_data: Dict) -> plt.Figure:
        ...
        # Add axis labels
        ax.text(-0.1, 1, matrix_data['y_axis']['categories'][1],
               ha='center', va='center', rotation=90, fontsize=14, fontweight='bold')
        ax.text(-0.1, 0, matrix_data['y_axis']['categories'][0],
               ha='center', va='center', rotation=90, fontsize=14, fontweight='bold')

        ax.text(0.5, -0.1, matrix_data['x_axis']['categories'][0],
               ha='center', va='center', fontsize=14, fontweight='bold')
        ax.text(1.5, -0.1, matrix_data['x_axis']['categories'][1],
               ha='center', va='center', fontsize=14, fontweight='bold')

        # Add main title
        ax.set_title(matrix_data['title'] + '\n' + matrix_data['subtitle'],
