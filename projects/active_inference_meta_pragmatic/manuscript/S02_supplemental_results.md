...
**Figure [2](#fig:efe_decomposition):** Mathematical decomposition of EFE components
**Figure [3](#fig:perception_action_loop):** Complete Active Inference cycle
**Figure [4](#fig:generative_model_structure):** A, B, C, D matrix relationships
**Figure [5](#fig:meta_level_concepts):** Meta-epistemic and meta-pragmatic aspects
**Figure [6](#fig:fep_system_boundaries):** Markov blanket visualization
**Figure [7](#fig:free_energy_dynamics):** Minimization trajectories
**Figure [8](#fig:structure_preservation):** System organization maintenance
