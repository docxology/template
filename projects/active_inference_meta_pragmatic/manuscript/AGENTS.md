...
This directory contains the complete research manuscript for "Active Inference as a Meta-(Pragmatic/Epistemic) Method". The manuscript is structured according to the Research Project Template standards with numbered sections, cross-references, and comprehensive documentation.
...
The manuscript is processed through the infrastructure rendering pipeline:
