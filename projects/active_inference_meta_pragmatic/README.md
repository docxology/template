...
@misc{friedman2025active,
  ...
  year={2025},
  note={Research Project Template Implementation}
}
```
...
Built using the Research Project Template framework. Special thanks to Karl Friston and the Active Inference research community for foundational theoretical work.