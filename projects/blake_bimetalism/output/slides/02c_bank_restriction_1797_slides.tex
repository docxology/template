...
Reality}
\protect\phantomsection\label{the-1797-bank-restriction-and-the-suspension-of-metallic-reality}
...
\begin{block}{The Collapse of Reserves and the Privy Council Order}
\protect\phantomsection\label{the-collapse-of-reserves-and-the-privy-council-order}
...
\begin{block}{The Atomic Swerve: Fiat Currency and the Media Ecology of
Forgery}
\protect\phantomsection\label{the-atomic-swerve-fiat-currency-and-the-media-ecology-of-forgery}
...
{[}@baucom2005specters; @erdman1954prophet{]}.
...
of the restriction era {[}@clapham1944bank;
@tooke1838history{]}.}\label{fig-historic-reserves}
\end{figure}
\end{block}

\begin{block}{Blake's \emph{Vala} and the Ontology of Paper Credit}
\protect\phantomsection\label{blakes-vala-and-the-ontology-of-paper-credit}
...
present reality {[}@brantlinger1996fictions; @tooke1838history{]}. Ian
...
{[}@baucom2005specters{]}. It was the total atomization of social value
...
\emph{Jerusalem}) {[}@makdisi2003william; @erdman1988complete{]}.
\end{block}

\begin{block}{The Bullionist Crisis and the Demand for Metallic Return}
\protect\phantomsection\label{the-bullionist-crisis-and-the-demand-for-metallic-return}
