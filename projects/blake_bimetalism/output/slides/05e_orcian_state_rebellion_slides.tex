...
\begin{block}{The Renaissance of State Monetary Federalism}
\protect\phantomsection\label{the-renaissance-of-state-monetary-federalism}
...
gold/silver coins as legal tender {[}@utah2011legal{]} \\
...
exempt {[}@wyoming2018legaltender{]} \\
\textbf{Arkansas} & Act 595 & 2023 & Full legal tender recognition and
tax exemption {[}@arkansas2023legaltender{]} \\
...
2025; partial effect Sept 2026 {[}@texas2025legaltender{]} \\
\textbf{Alabama} & SB 130 & 2026 & Passed House 102-0; comprehensive
legal tender and tax provisions {[}@alabama2026legaltender{]} \\
...
\begin{block}{Dismantling the Tax Architecture of Fiat Enforcement}
\protect\phantomsection\label{dismantling-the-tax-architecture-of-fiat-enforcement}
...
@florida2025legaltender; @alabama2026legaltender;
@nebraska2026metals{]}. Nebraska's LB 1317 is particularly significant:
...
constitutionally valid money {[}@nebraska2026metals{]}.
...
against the empire of abstract debt {[}@erdman1988complete{]}.
\end{block}
\end{frame}
