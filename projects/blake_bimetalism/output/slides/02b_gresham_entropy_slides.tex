...
\begin{frame}{Gresham's Law and the Fracture of Esoteric Alchemy}
\protect\phantomsection\label{greshams-law-and-the-fracture-of-esoteric-alchemy}
...
\begin{block}{Velde's Mathematical Formalism of Bimetallic Instability}
\protect\phantomsection\label{veldes-mathematical-formalism-of-bimetallic-instability}
...
circulating silver {[}@quinn2006bank{]}. This arbitrage drained the
...
\begin{block}{Del Mar's Esoteric Reading of the Bimetallic Marriage}
\protect\phantomsection\label{del-mars-esoteric-reading-of-the-bimetallic-marriage}
...
the sovereign prerogative of the state {[}@delmar1895history{]}. Del Mar
writes extensively on the sacred, often solar and lunar origins of
...
fiction {[}@flandreau1996bimetallism{]}.
\end{block}

\begin{block}{The Decay from Generation to Ulro}
\protect\phantomsection\label{the-decay-from-generation-to-ulro}
...
Erdman p.~170) {[}@erdman1988complete; @sklar2011blake{]}, he describes
