...
3. **LLM-assisted rewriting** — pipe long sentences and passive candidates into `infrastructure.llm` for suggested rewrites, with the same `seed=42, temperature=0.0` reproducibility contract used by `template_search_project`.
