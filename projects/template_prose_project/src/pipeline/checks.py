...
def _check_no_skipped_levels(report: ManuscriptReport, _config: ProjectConfig, **_: object) -> CheckResult:
...
def _check_h1_per_file(report: ManuscriptReport, _config: ProjectConfig, **_: object) -> CheckResult:
