...
\begin{frame}[fragile]{Stakeholders and use cases}
\protect\phantomsection\label{stakeholders-and-use-cases}
...
@star1989: different groups attach different meanings while aligning on
the same file versions.
