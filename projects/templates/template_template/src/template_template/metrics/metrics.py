...
from ..core.introspection import ModuleInfo, build_infrastructure_report
from ..core.contracts import METRICS_SCHEMA_VERSION, validate_metrics_payload
from ..figures.viz_palette import FIGURE_DPI, FONT_FLOOR
...
def build_manuscript_metrics_dict(repo_root: Path) -> dict[str, Any]:
    ...
    # names into a public DOI; ``tests/core/test_confidentiality.py`` is the negative
