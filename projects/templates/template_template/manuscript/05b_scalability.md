...
We have validated scaling with three canonical exemplars under `projects/templates/`—always present for onboarding and tooling—and with this manuscript from `projects/templates/template_template` (${project_template_template_test_count} tests) as a git-tracked public exemplar in the same automated discovery menus.
