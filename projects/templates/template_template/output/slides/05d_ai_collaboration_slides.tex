...
\breakseq{[@anthropic2024mcp]}, provides a bridge to the agentic software
paradigm. Lu et al.'s AI Scientist \breakseq{[@lu2024aiscientist]} demonstrates
end-to-end autonomous research, while OpenHands is evaluated on
SWE-Bench Verified \breakseq{[@wang2024opendevin; @jimenez2024swebench]}. These
systems motivate structured, protocol-aligned tool inventories for
unfamiliar codebases. An agent navigating \texttt{template/} reads
\texttt{CLAUDE.md} for global constraints, scans \texttt{AGENTS.md} for
local contracts, and can invoke skill-enabled capabilities through
\texttt{SKILL.md} descriptors. The live module inventory verifies
\texttt{AGENTS.md} and \texttt{README.md} coverage; \texttt{SKILL.md}
remains a capability-specific layer rather than a universal claim about
every infrastructure directory.
