...
¹``Core-only'' excludes LLM-tagged and other opt-in stages according to
...
\endhead
Test files & 504+ \\
Total tests & \textasciitilde8,583 \\
...
\begin{frame}[allowframebreaks]{Steganographic Performance Boundary}
\protect\phantomsection\label{steganographic-performance-boundary}
...
¹ Nextflow lineage records exist at workflow scope, not per rendered PDF
citation graph.
