...
| `template_prose_project` | Prose-heavy workflow | Validates narrative-only repos | 144 | Lightweight / optional plots |
| `template_autoresearch_project` | AutoResearch readiness | Planner + validation CLI | 303 | Readiness reports from Stage 02 |
