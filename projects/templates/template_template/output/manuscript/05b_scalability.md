...
- **`template_prose_project`**: Prose-heavy manuscript emphasizing narrative structure and bibliography discipline, with 144 discovered tests and the same declared project-source floor; tests exercise rendering and Markdown integrity without heavyweight numerics.
...
These workspaces share no project-level code—only Layer 1 (28 infrastructure subdirectories, ~718 Python files)—validating insulation between domain repos and reusable services.
...
|--------|:--------------:|:------------------------:|:----------:|
| Source modules | 26 | 8 | 61 |
| Test files | 12 | 12 | 21 |
| Test count | 243 | 144 | 303 |
