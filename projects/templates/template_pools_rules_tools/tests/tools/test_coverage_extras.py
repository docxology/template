...
from template_pools_rules_tools.tools.fonds_reader import read_all_fonds
...
def test_read_bibliography_fond_missing_bib_returns_none(tmp_path: pathlib.Path) -> None:
    from template_pools_rules_tools.tools.fonds_reader import read_bibliography_fond
...
def test_read_contacts_fond_missing_contacts_yaml_returns_none(tmp_path: pathlib.Path) -> None:
    from template_pools_rules_tools.tools.fonds_reader import read_contacts_fond
...
def test_read_datasets_fond_missing_datasets_yaml_returns_none(tmp_path: pathlib.Path) -> None:
    from template_pools_rules_tools.tools.fonds_reader import read_datasets_fond
...
def test_load_soft_rules_unreadable_file_skips(tmp_path: pathlib.Path) -> None:
    from template_pools_rules_tools.rules.rules_applier import load_soft_rules
...
def test_load_strong_rules_invalid_yaml_skips(tmp_path: pathlib.Path) -> None:
    from template_pools_rules_tools.rules.rules_applier import load_strong_rules
...
def test_validate_against_rules_missing_rules_yaml_warns(tmp_path: pathlib.Path) -> None:
    from template_pools_rules_tools.rules.rules_applier import validate_against_rules
...
def test_discover_tools_missing_root_returns_empty(tmp_path: pathlib.Path) -> None:
    from template_pools_rules_tools.tools.tools_invoker import discover_tools
...
def test_validate_tool_scripts_exist_missing_entrypoint(tmp_path: pathlib.Path) -> None:
    from template_pools_rules_tools.tools.tools_invoker import validate_tool_scripts_exist
...
def test_count_summary_with_explicit_fonds() -> None:
    from template_pools_rules_tools.tools.fonds_reader import count_summary
    from template_pools_rules_tools.tools.type_defs import (
        AllFondsResult,
...
def test_derive_dashboard_data_binds_to_ground_truth() -> None:
    ...
    from template_pools_rules_tools.tools.integration import derive_dashboard_data
    from template_pools_rules_tools.tools.type_defs import (
        AllFondsResult,
        IntegrationResult,
        IntegrationSummary,
...
def test_discover_tools_with_validation(tmp_path: pathlib.Path) -> None:
    from template_pools_rules_tools.tools.tools_invoker import discover_tools_with_validation
...
def test_get_tool_entrypoints_invalid_yaml(tmp_path: pathlib.Path) -> None:
    from template_pools_rules_tools.tools.tools_invoker import get_tool_entrypoints
