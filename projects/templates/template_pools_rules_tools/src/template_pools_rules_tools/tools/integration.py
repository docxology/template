...
from ..rules.rules_applier import validate_against_rules
from ..rules.strong_rule_evaluator import parse_bib_entries
...
# projects/templates/template_pools_rules_tools/src/tools/integration.py -> project root
...
def derive_dashboard_data(
    ...
    Binds ``src/figures/figures.py``'s ``generate_resource_counts()`` and
