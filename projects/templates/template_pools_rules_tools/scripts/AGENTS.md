...
(negative control: `tests/rules/test_strong_rule_evaluator.py::test_section_schema_flags_missing_section`
...
referenced figures declared in `src/figures/figures.py` are present. Cover art remains
