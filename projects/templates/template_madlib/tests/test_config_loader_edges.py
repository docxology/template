"""
Extended loader edge cases: fail-closed rejection of malformed or
incomplete madlib configuration blocks.
"""
...
import pytest
import yaml
from template_madlib.config import MadlibConfigError, load_madlib_config
