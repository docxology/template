...
Behavior tests for `src/template_code_project/analysis/` (one-to-one
...
- [`../../src/template_code_project/AGENTS.md`](../../src/template_code_project/AGENTS.md) — package-level module map covering `analysis/`.
