...
from template_code_project.core.experiment_config import ExperimentConfig, load_experiment_config
from template_code_project.core.optimizer import OptimizationResult
from template_code_project.core.project_paths import project_root_context
...
class TestCompareAlgorithms:
    ...
    def test_compare_returns_algorithm_comparison(self):
        ...
        from template_code_project.core.experiment_config import ExperimentConfig
...
class TestAlphaSweepConfigResolvedAlphas:
    """core/sweeps.py resolved_alphas: ValueError when neither alphas nor min/max/num provided."""
    ...
    def test_resolved_alphas_raises_when_all_none(self):
        ...
        import numpy as np
        from template_code_project.core.sweeps import AlphaSweepConfig
