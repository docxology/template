...
from template_code_project.dashboard.dashboard_payload import validate_dashboard_payload
...
class TestDashboardPayload:
    ...
    def test_compute_payload_records_sweep_exception(self):
        from template_code_project.core.invariants import OptimizerSweepConfig
        from template_code_project.core.sweeps import run_alpha_sweep
