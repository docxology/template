"""Tests for manuscript figure writers (src/template_autopoiesis/manuscript/manuscript_figures.py)."""
...
from template_autopoiesis.core.grammar import KNOWN_DOMAINS
from template_autopoiesis.manuscript.manuscript_figures import (
    _teal_slate_palette,
