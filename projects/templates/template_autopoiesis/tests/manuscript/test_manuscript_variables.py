...
from template_autopoiesis.manuscript.manuscript_variables import (
    generate_variables,
...
def test_md_table_shape():
    ...
    from template_autopoiesis.core.grammar import load_grammar
...
def test_example_parameters_are_bound_to_executable_primitive_specs():
    from template_autopoiesis.core.common import DERIVED_SEED_BITS, HASH_PREFIX_HEX_LENGTH
...
def test_honesty_manifest_tokens():
    ...
    # The honesty manifest in src/template_autopoiesis/core/honesty.py has STRUCTURAL_EVIDENCE with 6 keys, not 4.
