"""Tests for src/template_autopoiesis/core/common.py — trunc() and the CheckResult/CheckReport dataclasses."""

from __future__ import annotations

from template_autopoiesis.core.common import CheckReport, CheckResult, trunc
