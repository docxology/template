...
from template_autopoiesis.core.grammar import (
    KNOWN_DOMAINS,
    GrammarSlot,
    parse_grammar,
    GrammarError,
)
from template_autopoiesis.core.expand import expand, derive_seed, sample
from template_autopoiesis.gates.integrity import sha256_text, merkle_root
...
def test_all_reserved_slots_effective_product_one():
    from template_autopoiesis.core.grammar import RESERVED_SLOTS
