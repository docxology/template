...
STRUCTURAL_EVIDENCE: dict[str, list[str]] = {
    "grammar_parses": ["src/template_autopoiesis/grammar.py::parse_grammar"],
    "expand_deterministic": [
        "src/template_autopoiesis/expand.py::expand",
        "src/template_autopoiesis/expand.py::_digest_index",
    ],
    "materialize_writes_files": ["src/template_autopoiesis/materialize.py::materialize"],
    "integrity_hashes": ["src/template_autopoiesis/integrity.py::tree_hash_from_content_hashes"],
    "verify_recomputes": ["src/template_autopoiesis/verify.py::verify_child"],
