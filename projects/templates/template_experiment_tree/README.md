...
**A Living Research Record: Version-Controlled Experiment Trees with Frozen Nodes** · v1.0 · MIT · Daniel Ari Friedman

Repository: [docxology/template_experiment_tree](https://github.com/docxology/template_experiment_tree)
...
| github | first-class | ✅ published | [docxology/template_experiment_tree](https://github.com/docxology/template_experiment_tree) | `GITHUB_TOKEN` |
...
| github_pages | first-class | ⚪ available | [docxology/template_experiment_tree](https://github.com/docxology/template_experiment_tree) | `GITHUB_TOKEN` |
...
_Keywords: reproducible research, experiment tracking, preregistration, living documents._
