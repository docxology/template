...
from template_autoresearch_project import diagnostics as diagnostics_module
from template_autoresearch_project.ml import mnist_fixture
from template_autoresearch_project.diagnostics import (
    bootstrap_intervals,
    calibration_report,
...
def test_mnist_fixture_regeneration_is_manual_maintenance_only(project_root: Path) -> None:
    ...
    default_execution_paths = (
        ...
        project_root / "src" / "template_autoresearch_project" / "loop" / "loop.py",
        project_root / "src" / "template_autoresearch_project" / "ml" / "task.py",
    )
    forbidden_snippets = (
        "regenerate_mnist_fixture(",
        "from src.ml.mnist_fixture",
        "import template_autoresearch_project.ml.mnist_fixture",
    )
