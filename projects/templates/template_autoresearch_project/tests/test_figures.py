...
from template_autoresearch_project.figures.figure_registry_contract import figure_method
from template_autoresearch_project.figures.figure_specs import ALL_FIGURE_LABELS, FIGURE_DISPATCH, FIGURE_METHODS
from template_autoresearch_project.figures.figure_style import (
...
from template_autoresearch_project.figures import (
...
from template_autoresearch_project.figures.figures_security import (
...
def test_status_color_canonical_and_muted_fallback():
    from template_autoresearch_project.figures.figures_core import _status_color
...
def test_first_label_index_raises_when_label_absent():
    from template_autoresearch_project.figures.figures_core import _first_label_index
...
def test_class_balance_count_returns_zero_when_no_match():
    from template_autoresearch_project.figures.figures_core import _class_balance_count
...
def test_styled_grid_skips_when_grid_disabled():
    ...
    from template_autoresearch_project.figures.figures_core import styled_grid
