...
from template_autoresearch_project.diagnostics.source_ledger import (
    load_source_ledger,
    source_age_summary,
...
def test_source_age_summary_returns_correct_buckets(tmp_path: Path) -> None:
    ...
    from template_autoresearch_project.diagnostics.source_ledger import SourceLedgerEntry
