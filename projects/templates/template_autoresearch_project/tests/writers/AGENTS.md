# tests/writers/ — agent contract

Behavior tests for `src/template_autoresearch_project/writers/` (one-to-one mirror
...
- [`../../src/template_autoresearch_project/AGENTS.md`](../../src/template_autoresearch_project/AGENTS.md) — package-level module map covering `writers/`.
