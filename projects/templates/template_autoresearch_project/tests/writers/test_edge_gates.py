...
from template_autoresearch_project.writers.artifact_content import _json_is_substantive, _value_is_substantive
from template_autoresearch_project.writers.research_object import research_object_manifest_payload
...
# writers/artifact_content.py — deeper edge cases
