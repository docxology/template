...
Behavior tests for `src/template_autoresearch_project/figures/` (one-to-one mirror
...
- [`../../src/template_autoresearch_project/AGENTS.md`](../../src/template_autoresearch_project/AGENTS.md) — package-level module map covering `figures/`.
