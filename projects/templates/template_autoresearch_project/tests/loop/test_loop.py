...
from template_autoresearch_project.loop.config import build_loop_config, load_manuscript_loop_settings
from template_autoresearch_project.loop.loop import build_claims, run_autoresearch_loop
...
def test_pre_extrinsic_phase_table_covers_manifest_settlement(
    ...
    from template_autoresearch_project.loop.loop_phases import PRE_EXTRINSIC_PHASES
