...
__all__ = [
    ...
    "demo_chain_report", "EXPORT_RECEIPT_SCHEMA", "export_receipt",
    "dimension_of", "known_units",
...
- [AGENTS.md](template_methods_paper/AGENTS.md) — API reference and infrastructure integration.
