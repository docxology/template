...
from template_autoscientists.agents.agents import DeterministicProposer  # noqa: E402
...
from template_autoscientists.analysis.objective import SyntheticObjective  # noqa: E402
from template_autoscientists.search.search import SearchConfig, run_search  # noqa: E402
...
def test_figure_registry_validates_manuscript_references(tmp_path: Path) -> None:
    ...
    ok, issues = validate_figure_registry(
        registry,
        Path(__file__).resolve().parents[2] / "manuscript",
