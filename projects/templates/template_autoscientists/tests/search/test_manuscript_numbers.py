...
from template_autoscientists.agents.agents import DeterministicProposer
from template_autoscientists.search.ablation import AblationRow, build_ablation_payload, run_ablations
from template_autoscientists.search.comparison import (
    build_comparison_payload,
    build_objective,
    run_comparison,
    summarize_run,
)
from template_autoscientists.analysis.objective import SyntheticObjective
from template_autoscientists.search.search import SearchConfig, run_search

_CONFIG_YAML = Path(__file__).resolve().parents[2] / "manuscript" / "config.yaml"
