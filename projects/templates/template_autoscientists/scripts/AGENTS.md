...
**Contract.** Scripts coordinate I/O + visualization only; experiment logic lives in `src/template_autoscientists/search/ablation.py` / `src/template_autoscientists/search/comparison.py`.
