"""Tests for src.manuscript.manuscript_variables."""
...
from template_prose_project.manuscript.manuscript_variables import (
    compute_variables,
    load_report_payload,
    substitute_in_text,
    write_variables,
...
def test_load_report_payload_rejects_non_object(tmp_path: Path):
    ...
    Mirrors src/pipeline/config.py::test_top_level_must_be_mapping — the report
