"""Tests for src.pipeline.prose_facade — protocols, helpers, and parse_bib_keys.
...
from template_prose_project.pipeline.prose_facade import HeadingView, parse_bib_keys, render_outline
