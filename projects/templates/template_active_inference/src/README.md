...
- `template_active_inference/json_io.py`, `template_active_inference/yaml_io.py` — shared JSON and memoized YAML reading/writing helpers.
- `template_active_inference/analysis.py`, `template_active_inference/invariants.py` — top-level analysis entry points and invariant checks.
