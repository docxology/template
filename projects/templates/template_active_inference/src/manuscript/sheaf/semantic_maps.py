...
ARTIFACT_PRODUCERS: dict[str, str] = {
    ...
    "output/figures/track_lane_promotion_map.png": "generate_figures.py",
...
ARTIFACT_CONSUMERS: dict[str, tuple[str, ...]] = {
    ...
    "output/figures/track_lane_promotion_map.png": ("methods_sheaf", "appendix_full_sheaf"),
...
ARTIFACT_GATES: dict[str, tuple[str, ...]] = {
    ...
    "output/figures/track_lane_promotion_map.png": ("validate_outputs", "figure_registry"),
