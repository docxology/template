...
| Analytical | `analytical/invariants.py` (+ facades at `template_active_inference/invariants.py`) | Closed-form invariant checks |
...
| JSON I/O | [`template_active_inference/json_io.py`](template_active_inference/json_io.py) | `load_json`, `read_json`, `write_json` shared helpers |
| YAML I/O | [`template_active_inference/yaml_io.py`](template_active_inference/yaml_io.py) | `load_yaml`, `read_yaml` shared memoized helpers |
