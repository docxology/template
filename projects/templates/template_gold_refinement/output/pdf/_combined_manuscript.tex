...
risk dimensions and the shared template evidence registry contributes
283 source-tiered facts when the validation gate has run.
...
9/9 registered claims supported. These are internal workflow results,
...
evaluation is a registered claim or gate. No human participants,
stochastic sampling, trained model, or inferential statistical test is
involved.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Purity progression across the five refinery stages from ore (9K) to nine-nines certification.}]{../figures/purity_progression.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Gold karat grading scale (9K--24K + nine-nines) with refinery stage markers.}]{../figures/karat_grading.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Mega-madlib token distribution across manuscript sections and lexicon categories.}]{../figures/token_density.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Provenance trace: ore \texorpdfstring{\ensuremath{\to}}{->} stages \texorpdfstring{\ensuremath{\to}}{->} certification purity flow.}]{../figures/provenance_sankey.png}}
...
(100.00\%). The plot is diagnostic rather than correlational: five stage
states and one ledger-level rate do not constitute independent
observations suitable for association testing. Its purpose is to reveal
disagreement between a late refinery state and weak overall claim
support without combining the two into one score.

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Stage purity plotted against the single project-level claim-support assay.}]{../figures/purity_claim_scatter.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Token selection heatmap: seed \texorpdfstring{\ensuremath{\times}}{x} category \texorpdfstring{\ensuremath{\to}}{->} selected index.}]{../figures/token_heatmap.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Integrity-gate matrix linking audit rules to tests, manuscript surfaces, and generated artifacts.}]{../figures/integrity_gate_matrix.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Formalism traceability from source-owned equation identifiers to source evidence.}]{../figures/formalism_traceability.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Implementation circuit from config-owned ore through generated manuscript artifacts and validation feedback.}]{../figures/implementation_circuit.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Claim-evidence assay showing supported contribution claims, evidence surfaces, and boundary classifications.}]{../figures/claim_evidence_assay.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Scientific-integrity risk matrix plotting severity, detectability, residual risk, and owning evidence surface.}]{../figures/integrity_risk_matrix.png}}
...
manuscript can report 283 source-tiered facts to the validation surface.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Evidence-tier ladder summarizing source tiers available to the shared template evidence registry.}]{../figures/evidence_tier_ladder.png}}
...
available to this variable pass: 283.
...
\bottomrule\noalign{}
\endlastfoot
claim\_evidence\_assay & yes & yes & 3952x2038 & 0.217 & 0.06027576 &
pass \\
evidence\_tier\_ladder & yes & yes & 3349x1332 & 0.223 & 0.05598645 &
pass \\
formalism\_traceability & yes & yes & 3315x1797 & 0.140 & 0.04434550 &
pass \\
implementation\_circuit & yes & yes & 2966x1843 & 0.068 & 0.02205485 &
pass \\
integrity\_gate\_matrix & yes & yes & 1818x2060 & 0.409 & 0.16204936 &
pass \\
integrity\_risk\_matrix & yes & yes & 2499x1910 & 0.380 & 0.01852528 &
pass \\
karat\_grading & yes & yes & 2961x1698 & 0.279 & 0.07300982 & pass \\
provenance\_sankey & yes & yes & 2850x1461 & 0.070 & 0.02178809 &
pass \\
purity\_claim\_scatter & yes & yes & 2336x1744 & 0.034 & 0.01607749 &
pass \\
...
\item
  \textbf{Generation timestamp:} 2026-07-11T04:09:00Z
\item
...
revision, \breaktt{8d3efef5bcbe8b23}, Python 3.12.13, and whether the
