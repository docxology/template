...
\ifXeTeX
\special{pdf:trailerid [ <9d00fdf13f3e35249f81296a5153f89c> <9d00fdf13f3e35249f81296a5153f89c> ]}
\fi
\ifPDFTeX
\pdftrailerid{}
\pdftrailer{/ID [ <9d00fdf13f3e35249f81296a5153f89c> <9d00fdf13f3e35249f81296a5153f89c> ]}
\fi
\ifLuaTeX
\pdfvariable trailerid {[ <9d00fdf13f3e35249f81296a5153f89c> <9d00fdf13f3e35249f81296a5153f89c> ]}
\fi
...
gold extraction, assaying, fineness, and hallmarking practice
\citep{marsden_house_2006, hallmarking_convention_1972}, while the
target domain is a reproducible computational manuscript rather than a
claim about universal writing quality.
...
The project-local claim assay reports 8/8 supported contribution claims
(100.00\%, passing), while the integrity model exposes 8 source-owned
risk dimensions and the shared template evidence registry contributes
258 source-tiered facts when the validation gate has run.
...
From cupellation and fire assay to chemical and electrolytic refining,
the process of separating noble metal from base ore has evolved into a
staged pipeline with measurement and certification checkpoints
\citep{marsden_house_2006}. Hallmarking regimes make the verification
layer socially and legally visible: the mark is not the metal itself,
but an auditable assertion about fineness and control
\citep{hallmarking_convention_1972, lbma_good_delivery_rules}. This
paper asks: can that pipeline serve as a \textbf{load-bearing}
operational model for scientific manuscript composition - not merely a
decorative analogy, but a real mapping from metallurgical stages to
template-infrastructure operations?
...
here as an analogy surface
\citep{marsden_house_2006, lbma_good_delivery_rules}:
...
available to this variable pass: 258.
...
\item
  \textbf{Seed:} 431
\item
  \textbf{Config hash:} 2411971d39e10f3d
\item
...
generation records \breaktt{2411971d39e10f3d}; analysis writes refinery,
...
The metallurgy literature supplies the fourth boundary. Gold extraction,
assaying, fineness, and hallmarking provide the source-domain vocabulary
for staged refinement and independent certification
\citep{marsden_house_2006, hallmarking_convention_1972, lbma_good_delivery_rules}.
This paper imports that relational structure. It does not import market
rules, assay tolerances, or regulatory authority into manuscript review.
...
Scholarship boundary & Do external references support the analogy,
reproducibility, provenance, and metallurgy framing without being used
as evidence for universal manuscript-quality claims? & The scope,
discussion, and evaluation sections cite the scholarship while keeping
certification local to source-owned gates. & manuscript/references.bib
and manuscript/07\_scope.md \\
...
Scholarship boundary & Citations must anchor framing and limitations
without substituting for domain validation & prerender citation/evidence
validation plus human source review \\
...
literature, provenance standards, and metallurgy references as
boundary-setting evidence, not as decorations added after the pipeline
already decided the claim
\citep{gentner1983structure, peng2011reproducible, wilkinson2016fair, marsden_house_2006}.
