---
name: template-eda-notebook
description: Exploratory data analysis notebook exemplar — notebook-to-src extraction workflow, tested EDA library, deterministic dataset, diagnostic figures.
version: 0.1.0
author: docxology
license: MIT
tags: [exemplar, eda, notebook, extraction]
---

# template-eda-notebook

Project-scoped skill for the in-repo exemplar at
`projects/templates/template_eda_notebook/`. Load this when working inside the project.

## When to Use

- Working inside the `template_eda_notebook` exemplar — running scripts, editing source,
...
uv run python scripts/pipeline/stage_02_analysis.py --project templates/template_eda_notebook
