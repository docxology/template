...
- [src/ — template_sia](src/template_sia/AGENTS.md)
- [Source — template_sia](src/template_sia/README.md)
- [src/figures/](src/template_sia/figures/AGENTS.md)
- [Figures — template_sia](src/template_sia/figures/README.md)
- [src/fixtures/](src/template_sia/fixtures/AGENTS.md)
- [Fixtures — template_sia](src/template_sia/fixtures/README.md)
- [Improvement gen 2](src/template_sia/fixtures/recorded_generations/gen_2/improvement.md)
- [Improvement gen 3](src/template_sia/fixtures/recorded_generations/gen_3/improvement.md)
