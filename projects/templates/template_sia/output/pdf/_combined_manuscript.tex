...
\makeatother
\hypersetup{
  pdftitle={Self-Improvement Agent Harness: A Deterministic SIA Exemplar},
...
\ifXeTeX
\special{pdf:trailerid [ <7a5805ea08b950edf6ddd972e4cef458> <7a5805ea08b950edf6ddd972e4cef458> ]}
\fi
\ifPDFTeX
\pdftrailerid{}
\pdftrailer{/ID [ <7a5805ea08b950edf6ddd972e4cef458> <7a5805ea08b950edf6ddd972e4cef458> ]}
\fi
\ifLuaTeX
\pdfvariable trailerid {[ <7a5805ea08b950edf6ddd972e4cef458> <7a5805ea08b950edf6ddd972e4cef458> ]}
\fi
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth,height=0.5\textheight,keepaspectratio,alt={Meta \texorpdfstring{\ensuremath{\to}}{->} Target \texorpdfstring{\ensuremath{\to}}{->} Feedback loop topology for the SIA harness, generated programmatically by write\_sia\_loop\_topology.}]{../figures/sia_loop_topology.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth,height=0.5\textheight,keepaspectratio,alt={Per-generation metric heatmap showing accuracy and sample count across SIA generations.}]{../figures/sia_generation_heatmap.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=0.5\textheight,keepaspectratio,alt={SIA metric progression across generations.}]{../figures/sia_metric_progression.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth,height=0.5\textheight,keepaspectratio,alt={Generation-over-generation metric delta (\texorpdfstring{\ensuremath{\Delta}}{Delta}accuracy) for the SIA loop, illustrating the incremental improvement at each self-refinement step.}]{../figures/sia_improvement_delta.png}
