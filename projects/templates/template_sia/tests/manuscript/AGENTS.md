...
Behavior tests for `src/template_sia/manuscript/` (one-to-one mirror per
...
- [`../../src/template_sia/AGENTS.md`](../../src/template_sia/AGENTS.md) — package-level module map covering `manuscript/`.
