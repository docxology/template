...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{uv}\NormalTok{ run python scripts/pipeline/stage\_02\_analysis.py }\AttributeTok{{-}{-}project}\NormalTok{ templates/template\_textbook}
\ExtensionTok{uv}\NormalTok{ run python scripts/pipeline/stage\_03\_render.py    }\AttributeTok{{-}{-}project}\NormalTok{ templates/template\_textbook}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth,height=0.5\textheight,keepaspectratio,alt={Overview schematic for ``Orientation to the Field''. Replace this generated placeholder with a real figure produced by src/visualization/plots.py.}]{../figures/part_0_orientation.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth,height=0.5\textheight,keepaspectratio,alt={Overview schematic for ``Core Methods and Tools''. Replace this generated placeholder with a real figure produced by src/visualization/plots.py.}]{../figures/part_0_core_methods.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth,height=0.5\textheight,keepaspectratio,alt={Overview schematic for ``Quantitative Foundations''. Replace this generated placeholder with a real figure produced by src/visualization/plots.py.}]{../figures/part_0_quantitative_foundations.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=0.5\textheight,keepaspectratio,alt={A logistic growth curve for three growth rates, approaching the carrying capacity K = 100. Produced deterministically by visualization.plots.plot\_logistic\_growth.}]{../figures/logistic_growth.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth,height=0.5\textheight,keepaspectratio,alt={Overview schematic for ``Building Blocks''. Replace this generated placeholder with a real figure produced by src/visualization/plots.py.}]{../figures/part_I_building_blocks.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth,height=0.5\textheight,keepaspectratio,alt={Overview schematic for ``Structure and Form''. Replace this generated placeholder with a real figure produced by src/visualization/plots.py.}]{../figures/part_I_structure_and_form.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth,height=0.5\textheight,keepaspectratio,alt={Overview schematic for ``Systems Overview''. Replace this generated placeholder with a real figure produced by src/visualization/plots.py.}]{../figures/part_II_systems_overview.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth,height=0.5\textheight,keepaspectratio,alt={Overview schematic for ``Dynamics and Change''. Replace this generated placeholder with a real figure produced by src/visualization/plots.py.}]{../figures/part_II_dynamics_and_change.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth,height=0.5\textheight,keepaspectratio,alt={Overview schematic for ``Regulation and Control''. Replace this generated placeholder with a real figure produced by src/visualization/plots.py.}]{../figures/part_II_regulation_and_control.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth,height=0.5\textheight,keepaspectratio,alt={Overview schematic for ``Applied Models''. Replace this generated placeholder with a real figure produced by src/visualization/plots.py.}]{../figures/part_III_applied_models.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth,height=0.5\textheight,keepaspectratio,alt={Overview schematic for ``Frontiers and Open Problems''. Replace this generated placeholder with a real figure produced by src/visualization/plots.py.}]{../figures/part_III_frontiers.png}
...
\item
  Add a hypothetical fourth condition (dose \texttt{3}) with a
  \emph{saturating} response --- use the fixture value \texttt{5.3}
  rather than the line's \texttt{6.3} prediction --- refit, and compare
  the new slope and \(R^2\).
\end{enumerate}
...
You can hard-break a line with an explicit
\texttt{\textless{}br\textgreater{}} element, or separate paragraphs
with a blank line. Escape literal Markdown with a backslash: *not
italic*.
...
: Column alignment --- left, centre, right. \{\#tbl:gallery\_alignment\}
