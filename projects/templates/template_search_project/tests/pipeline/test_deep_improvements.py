...
from template_search_project.search.deep_search import DEEP_PROMPT
from template_search_project.pipeline.dotenv import load_dotenv
from template_search_project.pipeline.synthesis import PROMPT_PER_PAPER
...
class TestLLMRuntimeCallable:
    ...
    def test_callable_uses_query_long_when_available(self) -> None:
        from template_search_project.pipeline import llm_runtime
...
class TestDeepSearchEdgeCases:
    ...
    def test_aggregate_report_without_bibtex(self, tmp_path: Path) -> None:
        ...
        from template_search_project.publish.config import DeepSearchConfig
        from template_search_project.search.deep_search import run_deep_search
    ...
    def test_per_paper_note_truncates_long_fulltext(self, tmp_path: Path) -> None:
        ...
        from template_search_project.search.deep_search import write_per_paper_note
    ...
    def test_build_rich_paper_block_handles_minimal_paper(self) -> None:
        ...
        """
        from infrastructure.search.literature import Paper as _Paper
        from template_search_project.search.deep_search import build_rich_paper_block
    ...
    def test_keyword_report_no_per_source_counts_skips_coverage(self, tmp_path: Path) -> None:
        ...
        from template_search_project.search.deep_search import KeywordResult, write_keyword_report
