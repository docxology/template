...
Behavior tests for `src/template_search_project/pipeline/` (one-to-one mirror
...
- [`../../src/template_search_project/AGENTS.md`](../../src/template_search_project/AGENTS.md) — package-level module map covering `pipeline/`.
