...
@pytest.mark.parametrize(
    ...
    [
        ...
        # enrichment:
        ("enrichment", "fetch_abstracts", "enrichment.fetch_abstracts", "`false`"),
        ...
        # deep_search:
        ("deep_search", "enabled", "deep_search.enabled", "`false`"),
        ("deep_search", "max_results_per_keyword", "deep_search.max_results_per_keyword", "`100`"),
        ("deep_search", "fetch_abstracts", "deep_search.fetch_abstracts", "`false`"),
        ("deep_search", "fetch_fulltext", "deep_search.fetch_fulltext", "`false`"),
        ("deep_search", "max_fulltext_chars", "deep_search.max_fulltext_chars", "`400000`"),
        ("deep_search", "llm_per_paper", "deep_search.llm_per_paper", "`false`"),
