...
> **Local safety overlay:** use this skill for analysis and architecture. Do not
> edit files or notebooks merely to explore latent briefing; implementation
> requires a separate, explicitly authorized build task and runtime-enforced
> budgets.
