...
\begin{block}{A. Detailed Technique Protocols}
\protect\phantomsection\label{a.-detailed-technique-protocols}
\begin{block}{A.1 Whip and Tongue Grafting Protocol}
\protect\phantomsection\label{a.1-whip-and-tongue-grafting-protocol}
...
\begin{block}{A.2 Cleft Grafting Protocol}
\protect\phantomsection\label{a.2-cleft-grafting-protocol}
...
\begin{block}{B. Species Compatibility Tables}
\protect\phantomsection\label{b.-species-compatibility-tables}
\begin{block}{B.1 Apple (Malus domestica) Compatibility}
\protect\phantomsection\label{b.1-apple-malus-domestica-compatibility}
...
\begin{block}{B.2 Pear (Pyrus communis) Compatibility}
\protect\phantomsection\label{b.2-pear-pyrus-communis-compatibility}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}llll@{}}
\toprule\noalign{}
Rootstock & Scion & Compatibility & Notes \\
...
\begin{block}{B.3 Stone Fruits Compatibility}
\protect\phantomsection\label{b.3-stone-fruits-compatibility}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}llll@{}}
\toprule\noalign{}
Rootstock & Scion & Compatibility & Notes \\
...
\begin{block}{C. Software API Documentation}
\protect\phantomsection\label{c.-software-api-documentation}
\begin{block}{C.1 Core Functions}
\protect\phantomsection\label{c.1-core-functions}
...
\begin{block}{C.2 Simulation Functions}
\protect\phantomsection\label{c.2-simulation-functions}
...
\begin{block}{D. Statistical Methods Details}
\protect\phantomsection\label{d.-statistical-methods-details}
\begin{block}{D.1 Success Rate Analysis}
\protect\phantomsection\label{d.1-success-rate-analysis}
...
\begin{block}{D.2 Correlation Analysis}
\protect\phantomsection\label{d.2-correlation-analysis}
...
\begin{block}{D.3 ANOVA for Technique Comparison}
\protect\phantomsection\label{d.3-anova-for-technique-comparison}
...
\begin{block}{E. Economic Model Parameters}
\protect\phantomsection\label{e.-economic-model-parameters}
\begin{block}{E.1 Cost Parameters}
\protect\phantomsection\label{e.1-cost-parameters}
...
\begin{block}{E.2 Revenue Parameters}
\protect\phantomsection\label{e.2-revenue-parameters}
...
\begin{block}{E.3 Economic Metrics}
\protect\phantomsection\label{e.3-economic-metrics}
...
\begin{block}{F. Environmental Parameter Ranges}
\protect\phantomsection\label{f.-environmental-parameter-ranges}
\begin{block}{F.1 Temperature Ranges by Species Type}
\protect\phantomsection\label{f.1-temperature-ranges-by-species-type}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}llll@{}}
\toprule\noalign{}
...
\begin{block}{F.2 Humidity Ranges}
\protect\phantomsection\label{f.2-humidity-ranges}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}llll@{}}
\toprule\noalign{}
...
\begin{block}{F.3 Seasonal Windows}
\protect\phantomsection\label{f.3-seasonal-windows}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}lll@{}}
\toprule\noalign{}
