...
from simulation import SimulationBase, SimulationState, SimpleSimulation
...
class TestSimulationState:
    ...
    def test_state_from_dict(self):
        ...
        data = {"iteration": 3, "parameters": {"b": 2}, "results": {}, "metadata": {}, "timestamp": "", "seed": None}
...
class TestSimulationBase:
    ...
    def test_should_continue_target_reached(self):
        ...
        sim = SimpleSimulation(
            parameters={"max_iterations": 100, "target_value": 0.0},
            seed=42
        )
        sim.initialize()
